import { fromMiliseconds as bn } from "@walletconnect/time";
import {
  safeJsonParse as pn,
  safeJsonStringify as wn,
...
const it =
  typeof globalThis == "object" && "crypto" in globalThis
    ? globalThis.crypto
    : void 0;
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const _t =
...
class An extends xn {
  ...
  update(e) {
    ...
    for (let a = 0; a < s; ) {
      ...
      r.set(e.subarray(a, a + u), this.pos),
        (this.pos += u),
        (a += u),
...
function le(t, e = !1) {
  return e
    ? { h: Number(t & wt), l: Number((t >> St) & wt) }
    : { h: Number((t >> St) & wt) | 0, l: Number(t & wt) | 0 };
}
function mn(t, e = !1) {
  ...
  process(e, n) {
    ...
    for (let d = 0; d < 80; d++) {
      ...
      (v = g | 0),
        ...
        (w = l | 0),
        (h = p | 0),
        ({ h: l, l: p } = x.add(D | 0, c | 0, O | 0, ot | 0)),
        (D = u | 0),
        (c = i | 0),
        (u = s | 0),
        (i = a | 0),
    ...
    ({ h: r, l: o } = x.add(this.Ah | 0, this.Al | 0, r | 0, o | 0)),
      ({ h: s, l: a } = x.add(this.Bh | 0, this.Bl | 0, s | 0, a | 0)),
      ({ h: u, l: i } = x.add(this.Ch | 0, this.Cl | 0, u | 0, i | 0)),
      ({ h: D, l: c } = x.add(this.Dh | 0, this.Dl | 0, D | 0, c | 0)),
      ({ h: l, l: p } = x.add(this.Eh | 0, this.El | 0, l | 0, p | 0)),
      ({ h: w, l: h } = x.add(this.Fh | 0, this.Fl | 0, w | 0, h | 0)),
      ({ h: g, l: S } = x.add(this.Gh | 0, this.Gl | 0, g | 0, S | 0)),
      ({ h: v, l: L } = x.add(this.Hh | 0, this.Hl | 0, v | 0, L | 0)),
      this.set(r, o, s, a, u, i, D, c, l, p, w, h, g, S, v, L);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
const Xn = Array.from({ length: 256 }, (t, e) =>
...
function Ee(t) {
  ...
  for (let o = 0, s = 0; o < n; o++, s += 2) {
    ...
    if (a === void 0 || u === void 0) {
      const i = t[s] + t[s + 1];
      throw new Error(
        'hex string expected, got non-hex character "' + i + '" at index ' + s
      );
    }
    r[o] = a * 16 + u;
  }
...
function Ot(t, e, n = {}) {
  const r = (o, s, a) => {
    ...
    if (!(a && i === void 0) && !u(i, t))
      throw new Error(
        "param " + String(o) + " is invalid. Expected " + s + ", got " + i
      );
  };
...
function Dr(t, e) {
  const n = new Array(e.length),
    r = e.reduce(
      (s, a, u) => (t.is0(a) ? s : ((n[u] = s), t.mul(s, a))),
      t.ONE
    ),
    o = t.inv(r);
  return (
    e.reduceRight(
      (s, a, u) => (t.is0(a) ? s : ((n[u] = t.mul(s, n[u])), t.mul(s, a))),
      o
    ),
    n
  );
...
function _e(t, e, n = !1, r = {}) {
  ...
  const u = Object.freeze({
    ...
    isValid: (i) => {
      if (typeof i != "bigint")
        throw new Error(
          "invalid field element: expected bigint, got " + typeof i
        );
      return M <= i && i < t;
    },
    is0: (i) => i === M,
    ...
    fromBytes: (i) => {
      if (i.length !== s)
        throw new Error(
          "Field.fromBytes: expected " + s + " bytes, got " + i.length
        );
      return n ? Et(i) : Pn(i);
    },
  });
...
function lr(t, e) {
  return {
    ...
    precomputeWindow(n, r) {
      const { windows: o, windowSize: s } = Mt(r, e),
        a = [];
      let u = n,
        i = u;
      for (let D = 0; D < o; D++) {
    ...
    wNAFUnsafe(n, r, o, s = t.ZERO) {
      const { windows: a, windowSize: u } = Mt(n, e),
        i = BigInt(2 ** n - 1),
        D = 2 ** n,
        c = BigInt(n);
      for (let l = 0; l < a; l++) {
    ...
    getPrecomputes(n, r, o) {
      let s = qt.get(r);
      return (
        s || ((s = this.precomputeWindow(r, n)), n !== 1 && qt.set(r, o(s))), s
      );
    },
    wNAFCached(n, r, o) {
      const s = $t(n);
    ...
    wNAFCachedUnsafe(n, r, o, s) {
      ...
      return a === 1
        ...
        : this.wNAFUnsafe(a, this.getPrecomputes(a, n, o), r, s);
    },
    setWindowSize(n, r) {
...
function pr(t) {
  return (
    ...
    Object.freeze({ ...me(t.n, t.nBitLength), ...t, p: t.Fp.ORDER })
  );
}
const G = BigInt(0),
  j = BigInt(1),
...
function yr(t) {
  const e = gr(t),
    ...
    p =
      ...
      ((y, f) => {
        try {
          return { isValid: !0, value: n.sqrt(y * n.inv(f)) };
        } catch {
    ...
    multiplyUnsafe(f, b = d.ZERO) {
      ...
      return (
        ...
        E === G
          ...
          : this.is0() || E === j
          ? this
          : q.wNAFCachedUnsafe(this, E, d.normalizeZ, b)
      );
    }
    isSmallOrder() {
  ...
  function st(y, f, b = {}) {
    ...
    const { prefix: E, scalar: B, pointBytes: C } = O(f),
      A = tt(b.context, E, y),
  ...
  function Ct(y, f, b, E = at) {
    const { context: B, zip215: C } = E,
      A = n.BYTES;
    (y = W("signature", y, 2 * A)),
      (f = W("message", f)),
      (b = W("publicKey", b, A)),
      C !== void 0 && Tt("zip215", C),
      o && (f = o(f));
    const U = Et(y.slice(A, 2 * A));
    let _, T, $;
    try {
      (_ = d.fromHex(b, C)),
        (T = d.fromHex(y.slice(0, A), C)),
        ($ = m.multiplyUnsafe(U));
    } catch {
      return !1;
    }
    ...
    return T.add(_.multiplyUnsafe(R))
      .subtract($)
      .clearCofactor()
      .equals(d.ZERO);
  }
...
function Le(t = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null
    ? Xt(globalThis.Buffer.allocUnsafe(t))
    : new Uint8Array(t);
}
function Oe(t, e) {
...
function Ir(t, e) {
  ...
  function p(h) {
    ...
    if (h[g] !== " ") {
      ...
      for (
        var L = ((h.length - g) * D + 1) >>> 0, d = new Uint8Array(L);
        h[g];

      ) {
        var m = n[h.charCodeAt(g)];
        if (m === 255) return;
        for (var F = 0, q = L - 1; (m !== 0 || F < v) && q !== -1; q--, F++)
          (m += (u * d[q]) >>> 0),
            (d[q] = m % 256 >>> 0),
            (m = (m / 256) >>> 0);
...
class zr {
  constructor(e, n, r, o) {
    (this.name = e),
      ...
      (this.baseEncode = r),
      (this.baseDecode = o),
      (this.encoder = new Lr(e, n, r)),
      (this.decoder = new Or(e, n, o));
  }
  encode(e) {
...
const Bt = ({ name: t, prefix: e, encode: n, decode: r }) => new zr(t, e, n, r),
  ht = ({ prefix: t, name: e, alphabet: n }) => {
  ...
  k = ({ name: t, prefix: e, bitsPerChar: n, alphabet: r }) =>
    Bt({
      prefix: e,
      name: t,
      encode(o) {
...
function Pt(t, r) {
  ...
  do {
    ...
    (a = t[s++]),
      (n += o < 28 ? (a & ke) << o : (a & ke) * Math.pow(2, o)),
      (o += 7);
  } while (a >= Uo);
...
function rt(t, e = "utf8") {
  ...
  return (e === "utf8" || e === "utf-8") &&
    globalThis.Buffer != null &&
    globalThis.Buffer.from != null
    ? Xt(globalThis.Buffer.from(t, "utf-8"))
...
async function Qo(t, e, n, r, o = bn(Date.now())) {
  const s = { alg: jt, typ: Zt },
    a = Qe(r.publicKey),
    u = o + n,
    i = { iss: a, sub: t, aud: e, iat: o, exp: u },
    D = rn({ header: s, payload: i }),
...
export {
  ...
  ut as JWT_DELIMITER,
  Dt as JWT_ENCODING,
  jt as JWT_IRIDIUM_ALG,
  Zt as JWT_IRIDIUM_TYP,
  Ne as KEY_PAIR_SEED_LENGTH,
  Kt as MULTICODEC_ED25519_BASE,
  dt as MULTICODEC_ED25519_ENCODING,
  Wt as MULTICODEC_ED25519_HEADER,
  Fe as MULTICODEC_ED25519_LENGTH,
  Xo as decodeData,
  tn as decodeIss,
  lt as decodeJSON,
  sn as decodeJWT,
