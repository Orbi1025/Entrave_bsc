import { EventEmitter as l } from "events";
import {
  safeJsonStringify as u,
  safeJsonParse as p,
...
class f {
  constructor(e) {
    if (
      ((this.url = e), (this.events = new l()), (this.registering = !1), !c(e))
    )
      throw new Error(
  ...
  register(e = this.url) {
    ...
    return (
      ...
      (this.registering = !0),
      new Promise((t, n) => {
        const s = g() ? void 0 : { rejectUnauthorized: !y(e) },
          o = new b(e, [], s);
        w()
          ? (o.onerror = (i) => {
              const a = i;
  ...
  emitError(e) {
    const t = this.parseError(
      new Error(
        e?.message || `WebSocket connection failed for host: ${d(this.url)}`
      )
    );
