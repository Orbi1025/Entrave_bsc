import { detect as ms } from "detect-browser";
import {
  toMiliseconds as Ke,
  FIVE_MINUTES as Kn,
  fromMiliseconds as ws,
...
import { getWindowMetadata as xs } from "@walletconnect/window-metadata";
import { recoverAddress as vs } from "viem";
import re from "bs58";
import { decode as Es, encode as Bs } from "@msgpack/msgpack";
import { base32 as Is } from "@scure/base";
import { decodeJWT as As } from "@walletconnect/relay-auth";
import { toString as st, fromString as ft, concat as oe } from "uint8arrays";
import { RELAY_JSONRPC as Ss } from "@walletconnect/relay-api";
import { blake2b as Ns } from "blakejs";
const xe = ":";
function Fe(t) {
...
function Yn(t) {
  ...
  return Gn({ namespace: e, reference: n });
}
function Os(t, e) {
  const { namespace: n, reference: r } = Fe(e);
  return Zn({ namespace: n, reference: r, address: t });
}
function Us(t) {
  return Ge(t, Wn);
}
...
var $s = Object.defineProperty,
  ...
  Ps = (t, e) => Cs(t, Ls(e)),
  tr = (t, e, n) => Ze(t, typeof e != "symbol" ? e + "" : e, n);
...
function Bt() {
  return !ne() && !!Fn() && navigator.product === er;
}
function Ms() {
  return (
    Bt() &&
  ...
  try {
    return (
      ...
      (e = t?.icons) != null &&
        e.length &&
        t.icons.length > 0 &&
        (t.icons = t.icons.filter((o) => o !== "")),
      Ps(Qn(Qn({}, r), t), {
        url: t?.url || r.url,
        name: t?.name || r.name,
        description: t?.description || r.description,
        icons:
          (n = t?.icons) != null && n.length && t.icons.length > 0
            ? t.icons
            : r.icons,
      })
    );
...
function sr() {
  return xs() || { name: "", description: "", url: "", icons: [""] };
}
function Fs(t, e) {
  var n;
  const r = Pt(),
    o = { protocol: t, version: e, env: r };
  return (
    r === "browser" &&
      (o.host = ((n = zn()) == null ? void 0 : n.host) || "unknown"),
    o
  );
}
function ir() {
...
function fr() {
  ...
  const e = Pt();
  return e === J.browser
    ? [e, ((t = zn()) == null ? void 0 : t.host) || "unknown"].join(":")
    : e;
}
function cr(t, e, n) {
  const r = ir(),
    o = fr();
  return [[t, e].join("-"), [rr, n].join("-"), r, o].join("/");
}
function zs({
  protocol: t,
  version: e,
...
function ii(t, e) {
  return ws((e || Date.now()) + Ke(t));
}
function fi(t) {
  return Date.now() >= Ke(t);
}
function ci(t, e) {
  return `${t}${e ? `:${e}` : ""}`;
}
  ...
  try {
    ...
    if (f === J.browser) {
      ...
      f === J.reactNative &&
        ...
        (await global.Linking.openURL(i));
  } catch (o) {
    console.error(o);
  }
}
...
function hr(t) {
  ...
  gr()
    ? (e = "_top")
    : (pr() || t.startsWith("https://") || t.startsWith("http://")) &&
      (e = "_blank"),
...
const Be = BigInt(2 ** 32 - 1),
  yr = BigInt(32);
function mr(t, e = !1) {
  return e
    ? { h: Number(t & Be), l: Number((t >> yr) & Be) }
    : { h: Number((t >> yr) & Be) | 0, l: Number(t & Be) | 0 };
}
function wr(t, e = !1) {
  const n = t.length;
...
const xr = (t, e, n) => t >>> n,
  ...
  At = (t, e, n) => (t >>> n) | (e << (32 - n)),
  St = (t, e, n) => (t << (32 - n)) | (e >>> n),
  se = (t, e, n) => (t << (64 - n)) | (e >>> (n - 32)),
  ie = (t, e, n) => (t >>> (n - 32)) | (e << (64 - n)),
  bi = (t, e) => e,
  yi = (t, e) => t,
  mi = (t, e, n) => (t << n) | (e >>> (32 - n)),
  wi = (t, e, n) => (e << n) | (t >>> (32 - n)),
  xi = (t, e, n) => (e << (n - 32)) | (t >>> (64 - n)),
  vi = (t, e, n) => (t << (n - 32)) | (e >>> (64 - n));
function dt(t, e, n, r) {
  const o = (e >>> 0) + (r >>> 0);
  return { h: (t + n + ((o / 2 ** 32) | 0)) | 0, l: o | 0 };
}
const tn = (t, e, n) => (t >>> 0) + (e >>> 0) + (n >>> 0),
  en = (t, e, n, r) => (e + n + r + ((t / 2 ** 32) | 0)) | 0,
  Ei = (t, e, n, r) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0),
  Bi = (t, e, n, r, o) => (e + n + r + o + ((t / 2 ** 32) | 0)) | 0,
  Ii = (t, e, n, r, o) =>
    (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0) + (o >>> 0),
  Ai = (t, e, n, r, o, s) => (e + n + r + o + s + ((t / 2 ** 32) | 0)) | 0,
  Gt =
...
const Ot = Er ? (t) => t : Si,
  ...
  Ni = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
function ce(t) {
...
function fn(t) {
  ...
  for (let o = 0, s = 0; o < n; o++, s += 2) {
    const i = Ar(t.charCodeAt(s)),
      f = Ar(t.charCodeAt(s + 1));
    if (i === void 0 || f === void 0) {
      const a = t[s] + t[s + 1];
      throw new Error(
        'hex string expected, got non-hex character "' + a + '" at index ' + s
      );
    }
    r[o] = i * 16 + f;
  }
...
class Ie {}
function ae(t) {
  const e = (r) => t().update(ht(r)).digest(),
    n = t();
  return (
...
function Ui(t) {
  const e = (r, o) => t(o).update(ht(r)).digest(),
    n = t({});
  return (
    (e.outputLen = n.outputLen),
    (e.blockLen = n.blockLen),
...
for (let t = 0, e = ue, n = 1, r = 0; t < 24; t++) {
  ([n, r] = [r, (2 * n + 3 * r) % 5]),
    Sr.push(2 * (5 * r + n)),
    Nr.push((((t + 1) * (t + 2)) / 2) % 64);
  let o = _i;
  for (let s = 0; s < 7; s++)
    (e = ((e << ue) ^ ((e >> Ri) * Ci)) % $i),
      e & Ti && (o ^= ue << ((ue << BigInt(s)) - ue));
  Or.push(o);
}
const Ur = wr(Or, !0),
  Li = Ur[0],
  ji = Ur[1],
  _r = (t, e, n) => (n > 32 ? xi(t, e, n) : mi(t, e, n)),
  Tr = (t, e, n) => (n > 32 ? vi(t, e, n) : wi(t, e, n));
function ki(t, e = 24) {
...
class qn extends Ie {
  ...
  writeInto(e) {
    ...
    for (let o = 0, s = e.length; o < s; ) {
      ...
      e.set(n.subarray(this.posOut, this.posOut + i), o),
        (this.posOut += i),
        (o += i);
    }
    return e;
...
const Pi = (t, e, n) => ae(() => new qn(e, t, n)),
  Hi = Pi(1, 136, 256 / 8);
function Di(t, e, n, r) {
...
class Rr extends Ie {
  ...
  update(e) {
    ...
    for (let i = 0; i < s; ) {
      ...
      r.set(e.subarray(i, i + f), this.pos),
        (this.pos += f),
        (i += f),
...
class Ki extends Rr {
  ...
  process(e, n) {
    ...
    for (let u = 16; u < 64; u++) {
      const h = _t[u - 15],
        g = _t[u - 2],
        w = gt(h, 7) ^ gt(h, 18) ^ (h >>> 3),
        y = gt(g, 17) ^ gt(g, 19) ^ (g >>> 10);
      _t[u] = (y + _t[u - 7] + w + _t[u - 16]) | 0;
    }
    let { A: r, B: o, C: s, D: i, E: f, F: a, G: l, H: c } = this;
    for (let u = 0; u < 64; u++) {
      const h = gt(f, 6) ^ gt(f, 11) ^ gt(f, 25),
        g = (c + h + Mi(f, a, l) + qi[u] + _t[u]) | 0,
        y = ((gt(r, 2) ^ gt(r, 13) ^ gt(r, 22)) + Vi(r, o, s)) | 0;
      (c = l),
        (l = a),
        (a = f),
        (f = (i + g) | 0),
...
class cn extends Rr {
  ...
  get() {
    ...
    return [e, n, r, o, s, i, f, a, l, c, u, h, g, w, y, x];
  }
  ...
  process(e, n) {
    for (let L = 0; L < 16; L++, n += 4)
      (Tt[L] = e.getUint32(n)), (Rt[L] = e.getUint32((n += 4)));
    for (let L = 16; L < 80; L++) {
      const V = Tt[L - 15] | 0,
        _ = Rt[L - 15] | 0,
        k = At(V, _, 1) ^ At(V, _, 8) ^ xr(V, _, 7),
        j = St(V, _, 1) ^ St(V, _, 8) ^ vr(V, _, 7),
        $ = Tt[L - 2] | 0,
        d = Rt[L - 2] | 0,
        m = At($, d, 19) ^ se($, d, 61) ^ xr($, d, 6),
        p = St($, d, 19) ^ ie($, d, 61) ^ vr($, d, 6),
        b = Ei(j, p, Rt[L - 7], Rt[L - 16]),
        v = Bi(b, k, m, Tt[L - 7], Tt[L - 16]);
      (Tt[L] = v | 0), (Rt[L] = b | 0);
    }
    let {
      Ah: r,
    ...
    for (let L = 0; L < 80; L++) {
      const V = At(u, h, 14) ^ At(u, h, 18) ^ se(u, h, 41),
        _ = St(u, h, 14) ^ St(u, h, 18) ^ ie(u, h, 41),
        k = (u & g) ^ (~u & y),
        j = (h & w) ^ (~h & x),
        $ = Ii(M, _, j, zi[L], Rt[L]),
        d = Ai($, R, V, k, Fi[L], Tt[L]),
        m = $ | 0,
        p = At(r, o, 28) ^ se(r, o, 34) ^ se(r, o, 39),
        b = St(r, o, 28) ^ ie(r, o, 34) ^ ie(r, o, 39),
        v = (r & s) ^ (r & f) ^ (s & f),
        B = (o & i) ^ (o & a) ^ (i & a);
      (R = y | 0),
        (M = x | 0),
    ...
    ({ h: r, l: o } = dt(this.Ah | 0, this.Al | 0, r | 0, o | 0)),
      ({ h: s, l: i } = dt(this.Bh | 0, this.Bl | 0, s | 0, i | 0)),
      ({ h: f, l: a } = dt(this.Ch | 0, this.Cl | 0, f | 0, a | 0)),
      ({ h: l, l: c } = dt(this.Dh | 0, this.Dl | 0, l | 0, c | 0)),
      ({ h: u, l: h } = dt(this.Eh | 0, this.El | 0, u | 0, h | 0)),
      ({ h: g, l: w } = dt(this.Fh | 0, this.Fl | 0, g | 0, w | 0)),
      ({ h: y, l: x } = dt(this.Gh | 0, this.Gl | 0, y | 0, x | 0)),
      ({ h: R, l: M } = dt(this.Hh | 0, this.Hl | 0, R | 0, M | 0)),
      this.set(r, o, s, i, f, a, l, c, u, h, g, w, y, x, R, M);
  }
  roundClean() {
    ut(Tt, Rt);
  }
...
function $t(t, e, n, r, o, s) {
  ...
  (l = en(x, l, u, f)),
    (a = x | 0),
    ({ Dh: y, Dl: w } = { Dh: y ^ l, Dl: w ^ a }),
    ({ Dh: y, Dl: w } = { Dh: bi(y, w), Dl: yi(y) }),
    ({ h: g, l: h } = dt(g, h, y, w)),
    ({ Bh: u, Bl: c } = { Bh: u ^ g, Bl: c ^ h }),
    ({ Bh: u, Bl: c } = { Bh: At(u, c, 24), Bl: St(u, c, 24) }),
    (N[2 * t] = a),
    (N[2 * t + 1] = l),
    (N[2 * e] = c),
    (N[2 * e + 1] = u),
...
function Ct(t, e, n, r, o, s) {
  ...
  (l = en(x, l, u, f)),
    (a = x | 0),
    ({ Dh: y, Dl: w } = { Dh: y ^ l, Dl: w ^ a }),
    ({ Dh: y, Dl: w } = { Dh: At(y, w, 16), Dl: St(y, w, 16) }),
    ({ h: g, l: h } = dt(g, h, y, w)),
    ({ Bh: u, Bl: c } = { Bh: u ^ g, Bl: c ^ h }),
    ({ Bh: u, Bl: c } = { Bh: se(u, c, 63), Bl: ie(u, c, 63) }),
    (N[2 * t] = a),
    (N[2 * t + 1] = l),
    (N[2 * e] = c),
    (N[2 * e + 1] = u),
...
class ef extends tf {
  constructor(e = {}) {
    ...
    super(128, n),
      ...
      (this.v7h = F[15] | 0),
      Qi(n, e, 64, 16, 16);
    let { key: r, personalization: o, salt: s } = e,
      i = 0;
    if (
      (r !== void 0 && ((r = ht(r)), (i = r.length)),
  ...
  compress(e, n, r) {
    ...
    (N[24] = F[8] ^ s),
      (N[25] = F[9] ^ o),
      r && ((N[28] = ~N[28]), (N[29] = ~N[29]));
    let i = 0;
    const f = Ji;
    for (let a = 0; a < 12; a++)
      $t(0, 4, 8, 12, e, n + 2 * f[i++]),
        Ct(0, 4, 8, 12, e, n + 2 * f[i++]),
        $t(1, 5, 9, 13, e, n + 2 * f[i++]),
        Ct(1, 5, 9, 13, e, n + 2 * f[i++]),
        $t(2, 6, 10, 14, e, n + 2 * f[i++]),
        Ct(2, 6, 10, 14, e, n + 2 * f[i++]),
        $t(3, 7, 11, 15, e, n + 2 * f[i++]),
        Ct(3, 7, 11, 15, e, n + 2 * f[i++]),
        $t(0, 5, 10, 15, e, n + 2 * f[i++]),
        Ct(0, 5, 10, 15, e, n + 2 * f[i++]),
        $t(1, 6, 11, 12, e, n + 2 * f[i++]),
        Ct(1, 6, 11, 12, e, n + 2 * f[i++]),
        $t(2, 7, 8, 13, e, n + 2 * f[i++]),
        Ct(2, 7, 8, 13, e, n + 2 * f[i++]),
        $t(3, 4, 9, 14, e, n + 2 * f[i++]),
        Ct(3, 4, 9, 14, e, n + 2 * f[i++]);
    (this.v0l ^= N[0] ^ N[16]),
      (this.v0h ^= N[1] ^ N[17]),
      (this.v1l ^= N[2] ^ N[18]),
      (this.v1h ^= N[3] ^ N[19]),
...
async function Lr(t, e, n) {
  return (
    (await vs({ hash: an(e), signature: n })).toLowerCase() === t.toLowerCase()
  );
}
async function jr(t, e, n, r, o, s) {
  ...
  try {
    const f = "0x1626ba7e",
      ...
      l = n.substring(2),
      c = (l.length / 2).toString(16).padStart(64, "0"),
      u = (e.startsWith("0x") ? e : an(e)).substring(2),
      h = f + u + a + c + l,
      g = await fetch(`${s || rf}/?chainId=${r}&projectId=${o}`, {
...
function ff(t) {
  const e = new Uint8Array(Buffer.from(t, "base64")),
    n = Array.from("TransactionData::").map((s) => s.charCodeAt(0)),
    r = new Uint8Array(n.length + e.length);
...
function af(t) {
  ...
  const r = Bs(n),
    o = Buffer.from("TX"),
    s = Buffer.concat([o, Buffer.from(r)]),
    i = Xi(s);
  return Is.encode(i).replace(/=+$/, "");
}
function un(t) {
  const e = [];
  let n = BigInt(t);
...
function uf(t) {
  const e = Buffer.from(t.signed.bodyBytes, "base64"),
    n = Buffer.from(t.signed.authInfoBytes, "base64"),
...
var lf = Object.defineProperty,
  ...
  Hr = (t, e, n) =>
    e in t
      ? lf(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (t[e] = n),
  ln = (t, e) => {
...
const qr = (t, e) => {
  ...
  const s = `URI: ${t.aud || t.uri}`,
    ...
    a = `Nonce: ${t.nonce}`,
    l = `Issued At: ${t.iat}`,
    c = t.exp ? `Expiration Time: ${t.exp}` : void 0,
...
- ${y}`
  ...
  return [n, r, "", o, "", s, i, f, a, l, c, u, h, g].filter((y) => y != null)
    .join(`
`);
};
function mf(t, e, n) {
  return (
    n.includes("did:pkh:") || (n = `did:pkh:${n}`),
    {
      h: { t: "caip122" },
      p: {
        iss: n,
...
function wf(t) {
  var e;
  const { authPayload: n, chains: r, methods: o } = t,
    s = n.statement || "";
    ...
    if (!(h != null && h.length))
      throw new Error(
        `Supported methods don't satisfy the requested: ${JSON.stringify(
          u
        )}, supported: ${JSON.stringify(o)}`
      );
    const g = hn("request", h, { chains: f }),
      w = Yr(a, "eip155", g);
    (c = ((e = n?.resources) == null ? void 0 : e.slice(0, -1)) || []),
      c.push(Ne(w));
  }
  return Dr(ln({}, n), {
    statement: Jr(s, Oe(c)),
...
function Fr(t, e) {
  var n, r;
  return (n = t?.att) != null && n[e]
    ? Object.keys((r = t?.att) == null ? void 0 : r[e])
    : [];
}
function vf(t) {
...
function bt(t) {
  ...
  e.forEach((n) => {
    ...
    Object.keys(r).forEach((o) => {
      ...
      if (!Array.isArray(s))
        throw new Error(
          `Ability limits ${o} must be an array of objects, found: ${s}`
        );
      if (!s.length)
        throw new Error(
      ...
      s.forEach((i) => {
        if (typeof i != "object")
          throw new Error(
            `Ability limits (${o}) must be an array of objects, found: ${i}`
          );
      });
    });
  });
...
function Yr(t, e, n) {
  ...
  t.att[e] = ln({}, n);
  const o =
      (r = Object.keys(t.att)) == null
        ? void 0
        : r.sort((i, f) => i.localeCompare(f)),
    s = { att: {} };
...
function Xr(t, e) {
  ...
  return (
    n.forEach((o) => {
      var s, i;
      Object.keys(((s = t.att) == null ? void 0 : s[o]) || {})
        .concat(Object.keys(((i = e.att) == null ? void 0 : i[o]) || {}))
        .sort((f, a) => f.localeCompare(a))
        .forEach((f) => {
          var a, l;
          r.att[o] = Dr(ln({}, r.att[o]), {
            [f]:
              ((a = t.att[o]) == null ? void 0 : a[f]) ||
              ((l = e.att[o]) == null ? void 0 : l[f]),
          });
        });
    }),
    r
...
function gn(t = "", e) {
  ...
  Object.keys(e.att).forEach((f) => {
    ...
    const c = Object.keys(l).map(
      (u) => (o++, `(${o}) '${u}': '${l[u].join("', '")}' for '${f}'.`)
    );
...
/*! noble-ciphers - MIT License (c) 2023 Paul Miller (paulmillr.com) */ function Qr(
  t
) {
  return (
    t instanceof Uint8Array ||
...
const ro = (t) => Uint8Array.from(t.split("").map((e) => e.charCodeAt(0))),
  Lf = ro("expand 16-byte k"),
  jf = ro("expand 32-byte k"),
  kf = jt(Lf),
  Pf = jt(jf);
function D(t, e) {
  return (t << e) | (t >>> (32 - e));
  ...
  return (
    ...
    (f, a, l, c, u = 0) => {
      ...
      if (w === 32) g.push((y = wn(f))), (x = Pf);
        ...
        (y = new Uint8Array(32)), y.set(f), y.set(f, 16), (x = kf), g.push(y);
...
class Vf {
  constructor(e) {
    ...
    (this.r[0] = n & 8191),
      ...
      (this.r[5] = (i >>> 1) & 8190),
      (this.r[6] = ((i >>> 14) | (f << 2)) & 8191),
      (this.r[7] = ((f >>> 11) | (a << 5)) & 8065),
  ...
  process(e, n, r = !1) {
    ...
    let d = s[0] + (R & 8191),
      ...
      O = s[9] + (($ >>> 5) | o),
      A = 0,
      T = A + d * f + m * (5 * x) + p * (5 * y) + b * (5 * w) + v * (5 * g);
    (A = T >>> 13),
      (T &= 8191),
      (T +=
        B * (5 * h) + E * (5 * u) + I * (5 * c) + S * (5 * l) + O * (5 * a)),
      (A += T >>> 13),
      (T &= 8191);
    ...
    (A = q >>> 13),
      (q &= 8191),
      (q +=
        B * (5 * x) + E * (5 * y) + I * (5 * w) + S * (5 * g) + O * (5 * h)),
      (A += q >>> 13),
      (q &= 8191);
    let P = A + d * h + m * u + p * c + b * l + v * a;
    (A = P >>> 13),
      (P &= 8191),
      (P += B * f + E * (5 * x) + I * (5 * y) + S * (5 * w) + O * (5 * g)),
      (A += P >>> 13),
      (P &= 8191);
    let K = A + d * g + m * h + p * u + b * c + v * l;
    (A = K >>> 13),
      (K &= 8191),
      (K += B * a + E * f + I * (5 * x) + S * (5 * y) + O * (5 * w)),
      (A += K >>> 13),
      (K &= 8191);
    let et = A + d * w + m * g + p * h + b * u + v * c;
    (A = et >>> 13),
      (et &= 8191),
      (et += B * l + E * a + I * f + S * (5 * x) + O * (5 * y)),
      (A += et >>> 13),
      (et &= 8191);
    let Z = A + d * y + m * w + p * g + b * h + v * u;
    (A = Z >>> 13),
      (Z &= 8191),
      (Z += B * c + E * l + I * a + S * f + O * (5 * x)),
      (A += Z >>> 13),
      (Z &= 8191);
    let z = A + d * x + m * y + p * w + b * g + v * h;
    (A = z >>> 13),
      (z &= 8191),
      (z += B * u + E * c + I * l + S * a + O * f),
      (A += z >>> 13),
      (z &= 8191),
      (A = ((A << 2) + A) | 0),
      (A = (A + T) | 0),
...
function qf(t) {
  const e = (r, o) => t(o).update(mn(r)).digest(),
...
const zf = Mf(Ff, { counterRight: !1, counterLength: 4, allowShortKeys: !1 }),
...
const Wf = (t) => (e, n, r) => ({
  ...
  co = Rf({ blockSize: 64, nonceLength: 12, tagLength: 16 }, Wf(zf));
class ao extends Ie {
  constructor(e, n) {
...
function Xf(t, e, n, r = 32) {
  ...
  n === void 0 && (n = uo);
  const i = new Uint8Array(s * o),
    f = _e.create(t, e),
    a = f._cloneInto(),
    l = new Uint8Array(f.outputLen);
  for (let c = 0; c < s; c++)
    (vn[0] = c + 1),
      a
        .update(c === 0 ? uo : l)
...
const Jf = (t, e, n, r, o) => Xf(t, Yf(t, e, n), r, o),
  Te = Ae,
  En = BigInt(0),
  Bn = BigInt(1);
function Re(t, e) {
...
function ke(t, e, n = {}) {
  ...
  Object.entries(e).forEach(([o, s]) => r(o, s, !1)),
    Object.entries(n).forEach(([o, s]) => r(o, s, !0));
}
function ho(t) {
  const e = new WeakMap();
  return (n, ...r) => {
...
function mo(t, e) {
  const n = (t.ORDER + Q) / po,
    r = t.pow(e, n);
  if (!t.eql(t.sqr(r), e)) throw new Error("Cannot find square root");
  return r;
}
function rc(t, e) {
  const n = (t.ORDER - go) / bo,
    r = t.mul(e, Dt),
    o = t.pow(r, n),
    s = t.mul(e, o),
    i = t.mul(t.mul(s, Dt), o),
    f = t.mul(s, t.sub(i, t.ONE));
...
function wo(t, e, n = !1) {
  const r = new Array(e.length).fill(n ? t.ZERO : void 0),
    o = e.reduce(
      (i, f, a) => (t.is0(f) ? i : ((r[a] = i), t.mul(i, f))),
      t.ONE
    ),
    s = t.inv(o);
  return (
    e.reduceRight(
      (i, f, a) => (t.is0(f) ? i : ((r[a] = t.mul(i, r[a])), t.mul(i, f))),
      s
    ),
    r
  );
...
function xo(t, e) {
  const n = (t.ORDER - Q) / Dt,
    r = t.pow(e, n),
    o = t.eql(r, t.ONE),
    s = t.eql(r, t.ZERO),
    i = t.eql(r, t.neg(t.ONE));
...
function Yt(t, e, n = !1, r = {}) {
  ...
  if (typeof e == "object" && e != null) {
    ...
    c.BITS && (o = c.BITS),
      c.sqrt && (s = c.sqrt),
      typeof c.isLE == "boolean" && (n = c.isLE);
  ...
  const l = Object.freeze({
    ...
    fromBytes: (c) => {
      if (c.length !== f)
        throw new Error(
          "Field.fromBytes: expected " + f + " bytes, got " + c.length
        );
      return n ? Le(c) : Ce(c);
    },
...
function pc(t, e) {
  return {
    ...
    precomputeWindow(n, r) {
      const { windows: o, windowSize: s } = On(r, e),
        i = [];
      let f = n,
        a = f;
      for (let l = 0; l < o; l++) {
    ...
    getPrecomputes(n, r, o) {
      ...
      return (
        s ||
          ((s = this.precomputeWindow(r, n)),
          n !== 1 && (typeof o == "function" && (s = o(s)), Un.set(r, s))),
        s
      );
    },
    wNAFCached(n, r, o) {
    ...
    wNAFCachedUnsafe(n, r, o, s) {
      ...
      return i === 1
        ...
        : this.wNAFUnsafe(i, this.getPrecomputes(i, n, o), r, s);
    },
    setWindowSize(n, r) {
...
function bc(t, e, n, r) {
  ...
  for (let g = u; g >= 0; g -= a) {
    ...
    for (let y = 0; y < s; y++) {
      const x = r[y],
        R = Number((x >> BigInt(g)) & l);
      c[R] = c[R].add(n[y]);
    }
    let w = i;
    for (let y = c.length - 1, x = i; y > 0; y--)
      (x = x.add(c[y])), (w = w.add(x));
...
function yc(t, e, n = {}) {
  ...
  for (const f of ["p", "n", "h"]) {
    const a = e[f];
    if (!(typeof a == "bigint" && a > Xt))
      throw new Error(`CURVE.${f} must be positive bigint`);
  }
  const r = No(e.p, n.Fp),
    o = No(e.n, n.Fn),
    i = ["Gx", "Gy", "a", t === "weierstrass" ? "b" : "d"];
  for (const f of i)
    if (!r.isValid(e[f]))
...
function mc(t) {
  return (
    ke(t, { adjustScalarBytes: "function", powPminus2: "function" }),
    Object.freeze({ ...t })
  );
}
function wc(t) {
  const e = mc(t),
    { P: n, type: r, adjustScalarBytes: o, powPminus2: s, randomBytes: i } = e,
    f = r === "x25519";
  ...
  const a = i || Zt,
    ...
    c = f ? 32 : 56,
    u = BigInt(f ? 9 : 5),
    h = BigInt(f ? 121665 : 39081),
    g = f ? Pe ** BigInt(254) : Pe ** BigInt(447),
    w = f
      ? BigInt(8) * Pe ** BigInt(251) - Jt
      : BigInt(4) * Pe ** BigInt(445) - Jt,
    y = g + w + Jt,
    x = (d) => lt(d, n),
    R = M(u);
  function M(d) {
  ...
  function j(d, m, p) {
    const b = x(d * (m - p));
    return (m = x(m - b)), (p = x(p + b)), { x_2: m, x_3: p };
  }
  function $(d, m) {
...
function Ic(t) {
  const e = BigInt(10),
    ...
    y = (pt(w, o, s) * g) % s,
    x = (pt(y, e, s) * c) % s;
  return { pow_p_5_8: (pt(x, Oo, s) * t) % s, b2: f };
}
function Ac(t) {
...
function _o(t) {
  t.lowS !== void 0 && Re("lowS", t.lowS),
    t.prehash !== void 0 && Re("prehash", t.prehash);
}
  ...
  function o(s) {
    ...
    if (typeof s == "bigint") i = s;
      ...
      try {
        ...
        throw new Error(
          `invalid private key: expected ui8a of size ${r}, got ${typeof s}`
        );
      }
    }
...
function _c(t, e = {}) {
  const { Fp: n, Fn: r } = yc("weierstrass", t, e),
    { h: o, n: s } = t;
  ke(
    e,
    {},
  ...
  if (
    i &&
    (!n.is0(t.a) ||
      typeof i.beta != "bigint" ||
      typeof i.splitScalar != "function")
  )
    throw new Error(
  ...
  function l($) {
    ...
    if (b === m && (v === 2 || v === 3)) {
      ...
      const E = n.fromBytes(B.subarray(d * 0, d * 1)),
        I = n.fromBytes(B.subarray(d * 1, d * 2));
      if (!g(E, I)) throw new Error("bad point: is not on curve");
      return { x: E, y: I };
    } else
      throw new Error(
        `bad point: got length ${b}, expected compressed=${m} or uncompressed=${p}`
      );
  }
  const c = e.toBytes || a,
    u = e.fromBytes || l,
  ...
  const w = n.mul(n.pow(t.a, He), Oc),
    y = n.mul(n.sqr(t.b), BigInt(27));
  ...
  class _ {
    ...
    equals(d) {
      R(d);
      const { px: m, py: p, pz: b } = this,
        { px: v, py: B, pz: E } = d,
        I = n.eql(n.mul(m, E), n.mul(v, b)),
        S = n.eql(n.mul(p, E), n.mul(B, b));
      return I && S;
    }
    negate() {
    ...
    multiply(d) {
      ...
      if (m) {
        const { k1neg: B, k1: E, k2neg: I, k2: S } = m.splitScalar(d),
          { p: O, f: A } = v(E),
          { p: T, f: U } = v(S);
    ...
    multiplyUnsafe(d) {
      ...
      if (m) {
        const { k1neg: b, k1: v, k2neg: B, k2: E } = m.splitScalar(d),
          { p1: I, p2: S } = gc(_, p, v, E);
  ...
  (_.BASE = new _(t.Gx, t.Gy, n.ONE)),
    (_.ZERO = new _(n.ZERO, n.ONE, n.ZERO)),
    (_.Fp = n),
    (_.Fn = r);
  const k = r.BITS,
    j = pc(_, e.endo ? Math.ceil(k / 2) : k);
  return _;
}
function Ro(t) {
...
function Tc(t, e, n = {}) {
  ...
  const r = e.randomBytes || Zt,
    o = e.hmac || ((p, ...b) => _e(e.hash, p, Ht(...b))),
    { Fp: s, Fn: i } = t,
    { ORDER: f, BITS: a } = i;
  function l(p) {
    const b = f >> pe;
  ...
  class h {
    constructor(b, v, B) {
      u("r", b),
        ...
        (this.r = b),
        (this.s = v),
        B != null && (this.recovery = B),
        Object.freeze(this);
    }
    static fromCompact(b) {
      const v = i.BYTES,
        B = rt("compactSignature", b, v * 2);
      return new h(
        i.fromBytes(B.subarray(0, v)),
        i.fromBytes(B.subarray(v, v * 2))
      );
    }
    static fromDER(b) {
    ...
    recoverPublicKey(b) {
      ...
      const A = s.toBytes(O),
        T = t.fromHex(Ht(Ro((I & 1) === 0), A)),
        U = i.inv(O),
        C = L(rt("msgHash", b)),
        H = i.create(-C * U),
        q = i.create(E * U),
        P = t.BASE.multiplyUnsafe(H).add(T.multiplyUnsafe(q));
    ...
    normalizeS() {
      return this.hasHighS()
        ? new h(this.r, i.neg(this.s), this.recovery)
        : this;
    }
    toBytes(b) {
  ...
  const g = To(i, n.allowedPrivateKeyLengths, n.wrapPrivateKey),
    w = {
      isValidPrivateKey(p) {
        try {
          return g(p), !0;
  ...
  function k(p, b, v = j) {
    ...
    function H(q) {
      ...
      const K = i.inv(P),
        et = t.BASE.multiply(P).toAffine(),
        Z = i.create(et.x);
      if (Z === he) return;
      const z = i.create(K * i.create(C + Z * A));
      if (z === he) return;
      let Ft = (et.x === Z ? 0 : 2) | Number(et.y & pe),
        yt = z;
      return E && l(z) && ((yt = c(z)), (Ft ^= 1)), new h(Z, yt, Ft);
    }
    return { seed: U, k2sig: H };
  }
  ...
  function m(p, b, v, B = $) {
    ...
    try {
      if (T)
        if (O === void 0 || O === "js") U = new h(E.r, E.s);
    ...
    const { r: H, s: q } = U,
      ...
      et = i.create(P * K),
      Z = i.create(H * K),
      z = t.BASE.multiplyUnsafe(et).add(C.multiplyUnsafe(Z));
...
const $o = {
  ...
  kc = Yt(Co.p),
  Pc = Yt(Lo.p),
  Hc = Rn({ ...$o, Fp: jc, lowS: !1 }, Ae);
Rn({ ...Co, Fp: kc, lowS: !1 }, Yi),
  Rn(
    { ...Lo, Fp: Pc, lowS: !1, allowedPrivateKeyLengths: [130, 131, 132] },
    Wi
  );
const Dc = Hc,
  $n = "base10",
  ...
  Ln = 32;
function Vc() {
  const t = Tn.utils.randomPrivateKey(),
    e = Tn.getPublicKey(t);
  return { privateKey: st(t, tt), publicKey: st(e, tt) };
}
function qc() {
  const t = Zt(Ln);
  return st(t, tt);
...
function Kc(t, e) {
  const n = Tn.getSharedSecret(ft(t, tt), ft(e, tt)),
    r = Jf(Te, n, void 0, void 0, Ln);
  return st(r, tt);
}
function Fc(t) {
  const e = Te(ft(t, tt));
...
function Gc(t) {
  ...
  const n = typeof t.senderPublicKey < "u" ? ft(t.senderPublicKey, tt) : void 0,
    r = typeof t.iv < "u" ? ft(t.iv, tt) : Zt(be),
    o = ft(t.symKey, tt),
    s = co(o, r).encrypt(ft(t.message, te)),
    i = kn({ type: e, sealed: s, iv: r, senderPublicKey: n });
  return t.encoding === De ? ko(i) : i;
}
function Zc(t) {
  const e = ft(t.symKey, tt),
    { sealed: n, iv: r } = Me({ encoded: t.encoded, encoding: t.encoding }),
    o = co(e, r).decrypt(n);
...
function Wc(t, e) {
  const n = jn(ge),
    r = Zt(be),
    o = ft(t, te),
    s = kn({ type: n, sealed: o, iv: r });
  return e === De ? ko(s) : s;
}
function Yc(t, e) {
  const { sealed: n } = Me({ encoded: t, encoding: e });
  return st(n, te);
}
function kn(t) {
  if (Vt(t.type) === ge) return st(oe([t.type, t.sealed]), Qt);
  if (Vt(t.type) === ee) {
    if (typeof t.senderPublicKey > "u")
      throw new Error("Missing sender public key for type 1 envelope");
    return st(oe([t.type, t.senderPublicKey, t.iv, t.sealed]), Qt);
  }
  return st(oe([t.type, t.iv, t.sealed]), Qt);
}
function Me(t) {
  const e = (t.encoding || Qt) === De ? Po(t.encoded) : t.encoded,
    n = ft(e, Qt),
    r = n.slice(Mc, jo),
    o = jo;
  if (Vt(r) === ee) {
...
function Xc(t, e) {
  const n = Me({ encoded: t, encoding: e?.encoding });
  return Ho({
    type: Vt(n.type),
    senderPublicKey:
      typeof n.senderPublicKey < "u" ? st(n.senderPublicKey, tt) : void 0,
...
function Do(t) {
  ...
  return oe([new Uint8Array([4]), e, n]);
}
function ta(t, e) {
  const [n, r, o] = t.split("."),
    s = Buffer.from(Po(o), "base64");
  if (s.length !== 64) throw new Error("Invalid signature length");
  const i = s.slice(0, 32),
    f = s.slice(32, 64),
    a = `${n}.${r}`,
    l = Te(a),
    c = Do(e);
  if (!Dc.verify(oe([i, f]), l, c)) throw new Error("Invalid signature");
  return As(t).payload;
}
const Mo = "irn";
function ea(t) {
...
var ia = Object.defineProperty,
  ...
  zo = (t, e, n) =>
    e in t
      ? ia(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (t[e] = n),
  la = (t, e) => {
...
function pa(t) {
  var e;
  const {
      proposal: { requiredNamespaces: n, optionalNamespaces: r = {} },
      supportedNamespaces: o,
    } = t,
    s = ye(n),
    i = ye(r),
    f = {};
  Object.keys(o).forEach((c) => {
    const u = o[c].chains,
      ...
      w = o[c].accounts;
    u.forEach((y) => {
      if (!w.some((x) => x.includes(y)))
        throw new Error(
          `No accounts provided for chain ${y} in namespace ${c}`
        );
    }),
  ...
  Object.keys(s).forEach((c) => {
    const u = o[c].chains.filter((y) => {
        var x, R;
        return (R = (x = s[c]) == null ? void 0 : x.chains) == null
          ? void 0
          : R.includes(y);
      }),
      h = o[c].methods.filter((y) => {
        var x, R;
        return (R = (x = s[c]) == null ? void 0 : x.methods) == null
          ? void 0
          : R.includes(y);
      }),
      g = o[c].events.filter((y) => {
        var x, R;
        return (R = (x = s[c]) == null ? void 0 : x.events) == null
          ? void 0
          : R.includes(y);
      }),
    ...
    Object.keys(i).forEach((c) => {
      ...
      if (!o[c]) return;
      const R =
          (h = (u = i[c]) == null ? void 0 : u.chains) == null
            ? void 0
            : h.filter((_) => o[c].chains.includes(_)),
        M = o[c].methods.filter((_) => {
          var k, j;
          return (j = (k = i[c]) == null ? void 0 : k.methods) == null
            ? void 0
            : j.includes(_);
        }),
        L = o[c].events.filter((_) => {
          var k, j;
          return (j = (k = i[c]) == null ? void 0 : k.events) == null
            ? void 0
            : j.includes(_);
        }),
        V = R?.map((_) =>
          o[c].accounts.filter((k) => k.includes(`${_}:`))
        ).flat();
      l[c] = {
  ...
  for (const [c, u] of Object.entries(l))
    (u.accounts.length === 0 ||
      ((e = u?.chains) == null ? void 0 : e.length) === 0) &&
      delete l[c];
  return l;
}
function Pn(t) {
...
function Xo(t) {
  ...
  return (
    t?.forEach((n) => {
      var r;
      const [o, s] = n.split(":");
      e[o] || (e[o] = { accounts: [], chains: [], events: [], methods: [] }),
        e[o].accounts.push(n),
        (r = e[o].chains) == null || r.push(`${o}:${s}`);
    }),
    e
  );
}
function ga(t, e) {
  ...
  for (const [r, o] of Object.entries(n))
    o.methods ? (o.methods = ct(o.methods, t)) : (o.methods = t),
...
function ba(t, e) {
  ...
  const a = ye(t),
    l = ye(e),
    c = {},
    u = Object.keys(a).concat(Object.keys(l));
  for (const h of u)
    c[h] = {
      chains: ct(
        (n = a[h]) == null ? void 0 : n.chains,
        (r = l[h]) == null ? void 0 : r.chains
      ),
      methods: ct(
        (o = a[h]) == null ? void 0 : o.methods,
        (s = l[h]) == null ? void 0 : s.methods
      ),
      events: ct(
        (i = a[h]) == null ? void 0 : i.events,
        (f = l[h]) == null ? void 0 : f.events
      ),
    };
  return c;
}
...
function ya(t, e) {
  ...
  return It(o, r)
    ? (r.forEach((i) => {
        const { accounts: f, methods: a, events: l } = t.namespaces[i],
          c = qt(f),
          u = n[i];
    ...
    me(e) && e.length
      ? e.forEach((o) => {
          r ||
            ...
            (r = Kt(
              "UNSUPPORTED_CHAINS",
              `${n}, chain ${o} should be a string and conform to "namespace:chainId" format`
            ));
        })
      : we(t) ||
        (r = Kt(
...
function Ea(t, e, n) {
  ...
  if (t && Ve(t)) {
    ...
    r = Et("MISSING_OR_INVALID", `${e}, ${n} should be an object with data`);
  return r;
}
function is(t, e) {
  let n = null;
  ...
  return (
    ...
    Object.keys(e).forEach((u) => {
      ...
      h.includes(u) ||
        (r = Et(
          "NON_CONFORMING_NAMESPACES",
          `${n} namespaces accounts don't satisfy namespace accounts for ${u}
        Required: ${u}
        Approved: ${h.toString()}`
        ));
    }),
    i.forEach((u) => {
      r ||
        (It(o[u].methods, s[u].methods)
          ? It(o[u].events, s[u].events) ||
            (r = Et(
              "NON_CONFORMING_NAMESPACES",
              `${n} namespaces events don't satisfy namespace events for ${u}`
            ))
          : (r = Et(
              "NON_CONFORMING_NAMESPACES",
              `${n} namespaces methods don't satisfy namespace methods for ${u}`
            )));
    }),
    r
  );
...
function Pa() {
  var t;
  return zt() && ne()
    ? ((t = ne()) == null ? void 0 : t.visibilityState) === "visible"
    : !0;
}
const Mn = {};
class Ha {
...
function bs({ publicKey: t, signature: e, payload: n }) {
  ...
  const o = Vn(n.method),
    s =
      128 | parseInt(((r = n.version) == null ? void 0 : r.toString()) || "4"),
    i = Ma(n.address),
    f = n.era === "00" ? new Uint8Array([0]) : Vn(n.era);
  if (f.length !== 1 && f.length !== 2) throw new Error("Invalid era length");
  const a = parseInt(n.nonce, 16),
    l = new Uint8Array([a & 255, (a >> 8) & 255]),
    c = BigInt(`0x${Da(n.tip)}`),
    u = qa(c),
    h = new Uint8Array([0, ...t, i, ...e, ...f, ...l, ...u, ...o]),
    g = Va(h.length + 1);
...
function Ka(t) {
  const e = Uint8Array.from(Buffer.from(t.signature, "hex")),
    n = gs(t.transaction.address),
    r = bs({ publicKey: n, signature: e, payload: t.transaction }),
