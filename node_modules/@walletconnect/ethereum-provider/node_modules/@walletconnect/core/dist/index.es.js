import Ji, { EventEmitter as ie } from "events";
import {
  HEARTBEAT_EVENTS as se,
  HeartBeat as Xi,
} from "@walletconnect/heartbeat";
import Zi from "@walletconnect/keyvaluestorage";
import {
  generateChildLogger as j,
  getLoggerContext as B,
  pino as Qi,
  getDefaultLoggerOptions as it,
  generatePlatformLogger as es,
} from "@walletconnect/logger";
import {
  IMessageTracker as ts,
  IPublisher as is,
  ISubscriber as ss,
  IRelayer as rs,
  IStore as ns,
  IJsonRpcHistory as os,
  IExpirer as as,
  IVerify as cs,
  IEchoClient as hs,
  IEventClient as ls,
...
import {
  ...
  THIRTY_DAYS as Re,
  FIVE_SECONDS as Ae,
  THIRTY_SECONDS as xe,
  toMiliseconds as $,
  ONE_MINUTE as st,
  ONE_SECOND as Q,
  FIVE_MINUTES as le,
  fromMiliseconds as rt,
} from "@walletconnect/time";
import {
  safeJsonStringify as gs,
  safeJsonParse as nt,
} from "@walletconnect/safe-json";
import * as Ie from "@walletconnect/relay-auth";
import { decodeJWT as ot } from "@walletconnect/relay-auth";
import {
  mapToObj as Ne,
  objToMap as $e,
  getInternalError as b,
  generateRandomBytes32 as ze,
  generateKeyPair as ps,
  deriveSymKey as ys,
  hashKey as bs,
  validateEncoding as ms,
  isTypeTwoEnvelope as at,
  encodeTypeTwoEnvelope as fs,
  isTypeOneEnvelope as ct,
  encrypt as Ds,
  validateDecoding as vs,
  decodeTypeTwoEnvelope as ws,
  decrypt as _s,
  deserialize as ht,
  decodeTypeByte as Es,
  BASE64 as lt,
  BASE16 as Is,
  hashMessage as Te,
  getRelayProtocolApi as ne,
  getRelayProtocolName as Ce,
  isUndefined as ue,
  createExpiringPromise as H,
  getSdkError as de,
  sleep as Ts,
  isAndroid as Cs,
  getAppId as ut,
  ...
  calcExpiry as ge,
  isNode as gt,
  formatRelayRpcUrl as Ss,
  subscribeToNetworkChange as Os,
  isAppVisible as Rs,
  isProposalStruct as As,
  isSessionStruct as xs,
  parseExpirerTarget as Ns,
  TYPE_1 as $s,
  formatUri as pt,
  parseUri as yt,
  createDelayedPromise as zs,
  engineEvent as Le,
  isExpired as bt,
  isValidParams as ke,
  isValidUrl as Ls,
  isValidString as ks,
  formatTopicTarget as js,
  formatIdTarget as Us,
  isTestRun as mt,
  isBrowser as Fs,
  verifyP256Jwt as Ms,
  uuidv4 as ft,
  formatUA as Ks,
  getAppMetadata as Bs,
} from "@walletconnect/utils";
import { toString as Vs } from "uint8arrays";
import { JsonRpcProvider as qs } from "@walletconnect/jsonrpc-provider";
import {
  getBigIntRpcId as je,
  isJsonRpcRequest as Dt,
  isJsonRpcResponse as vt,
  formatJsonRpcResult as wt,
  formatJsonRpcRequest as _t,
  formatJsonRpcError as Gs,
  isJsonRpcResult as Ws,
  isJsonRpcError as Et,
} from "@walletconnect/jsonrpc-utils";
import Hs from "@walletconnect/jsonrpc-ws-connection";
import { getDocument as Ys } from "@walletconnect/window-getters";
const Ue = "wc",
  Fe = 2,
  pe = "core",
  W = `${Ue}@2:${pe}:`,
  It = { name: pe, logger: "error" },
  Tt = { database: ":memory:" },
  Ct = "crypto",
  ...
  $t = "irn",
  zt = "error",
  Ke = "wss://relay.walletconnect.org",
  Lt = "relayer",
  C = {
  ...
  ye = { inbound: "inbound", outbound: "outbound" },
  Ut = "0.3",
  Ft = "WALLETCONNECT_CLIENT_ID",
  Be = "WALLETCONNECT_LINK_MODE_APPS",
  U = {
  ...
  oe = {
    wc_pairingDelete: {
      req: { ttl: re, prompt: !1, tag: 1e3 },
      res: { ttl: re, prompt: !1, tag: 1001 },
    },
    wc_pairingPing: {
      req: { ttl: xe, prompt: !1, tag: 1002 },
      res: { ttl: xe, prompt: !1, tag: 1003 },
    },
    unregistered_method: {
      req: { ttl: re, prompt: !1, tag: 0 },
      res: { ttl: re, prompt: !1, tag: 0 },
    },
  },
  ae = {
  ...
  tr = re,
  Yt = "verify-api",
  ir = "https://verify.walletconnect.com",
  Jt = "https://verify.walletconnect.org",
  be = Jt,
  Xt = `${be}/v3`,
  Zt = [ir, Jt],
  Qt = "echo",
  ei = "https://echo.walletconnect.com",
  sr = "event-client",
  Y = {
  ...
  ii = "event-client",
  si = 86400,
  ri = "https://pulse.walletconnect.org/batch";
function cr(r, e) {
  ...
  function p(u) {
    ...
    for (var m = 0, D = 0, _ = 0, E = u.length; _ !== E && u[_] === 0; )
      _++, m++;
  ...
  function y(u) {
    ...
    if (u[m] !== " ") {
      ...
      for (
        var E = ((u.length - m) * h + 1) >>> 0, L = new Uint8Array(E);
        u[m];

      ) {
        var I = t[u.charCodeAt(m)];
        if (I === 255) return;
        for (var k = 0, T = E - 1; (I !== 0 || k < _) && T !== -1; T--, k++)
          (I += (a * L[T]) >>> 0),
            (L[T] = I % 256 >>> 0),
            (I = (I / 256) >>> 0);
      ...
      if (u[m] !== " ") {
        ...
        for (var O = new Uint8Array(D + (E - S)), te = D; S !== E; )
          O[te++] = L[S++];
        return O;
      }
    }
...
const ni = (r) => {
  ...
  ur = (r) => new TextEncoder().encode(r),
  dr = (r) => new TextDecoder().decode(r);
class gr {
  constructor(e, t, i) {
...
class br {
  constructor(e, t, i, s) {
    (this.name = e),
      ...
      (this.baseEncode = i),
      (this.baseDecode = s),
      (this.encoder = new gr(e, t, i)),
      (this.decoder = new pr(e, t, s));
  }
  encode(e) {
...
const Se = ({ name: r, prefix: e, encode: t, decode: i }) => new br(r, e, t, i),
  me = ({ prefix: r, name: e, alphabet: t }) => {
    const { encode: i, decode: s } = lr(t, e);
    return Se({ prefix: r, name: e, encode: i, decode: (n) => ni(s(n)) });
  },
  mr = (r, e, t, i) => {
    const s = {};
  ...
  A = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i }) =>
    Se({
      prefix: e,
      name: r,
      encode(s) {
...
const wr = A({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
...
const Tr = me({ prefix: "9", name: "base10", alphabet: "0123456789" });
...
const ai = Array.from(
  ...
  Xr = ai.reduce((r, e, t) => ((r[t] = e), r), []),
  Zr = ai.reduce((r, e, t) => ((r[e.codePointAt(0)] = t), r), []);
function Qr(r) {
...
var sn = Object.freeze({ __proto__: null, base256emoji: tn }),
  rn = hi,
  ci = 128,
  nn = 127,
  on = ~nn,
...
function Ve(r, i) {
  ...
  do {
    if (n >= a)
      throw ((Ve.bytes = 0), new RangeError("Could not decode varint"));
    (o = r[n++]),
      (t += s < 28 ? (o & li) << s : (o & li) * Math.pow(2, s)),
      (s += 7);
  } while (o >= hn);
...
var ln = Math.pow(2, 7),
  ...
  vn = { encode: rn, decode: cn, encodingLength: Dn },
  ui = vn;
const di = (r, e, t = 0) => (ui.encode(r, e, t), e),
  gi = (r) => ui.encodingLength(r),
  qe = (r, e) => {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array
        ? qe(this.code, t)
        : t.then((i) => qe(this.code, i));
    } else throw Error("Unknown type, must be binary type");
  }
}
const yi = (r) => async (e) => new Uint8Array(await crypto.subtle.digest(r, e)),
  En = pi({ name: "sha2-256", code: 18, encode: yi("SHA-256") }),
  In = pi({ name: "sha2-512", code: 19, encode: yi("SHA-512") });
var Tn = Object.freeze({ __proto__: null, sha256: En, sha512: In });
const bi = 0,
  Cn = "identity",
  mi = ni,
  Pn = (r) => qe(bi, mi(r)),
  Sn = { code: bi, name: Cn, encode: mi, digest: Pn };
...
function Rn(r = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null
    ? Di(globalThis.Buffer.allocUnsafe(r))
    : new Uint8Array(r);
}
function vi(r, e, t, i) {
  return {
...
function xn(r, e = "utf8") {
  ...
  return (e === "utf8" || e === "utf-8") &&
    ...
    ? Di(globalThis.Buffer.from(r, "utf-8"))
    : t.decoder.decode(`${t.prefix}${r}`);
}
var Nn = Object.defineProperty,
  $n = (r, e, t) =>
    e in r
      ? Nn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  J = (r, e, t) => $n(r, typeof e != "symbol" ? e + "" : e, t);
class _i {
  constructor(e, t) {
    (this.core = e),
      (this.logger = t),
      J(this, "keychain", new Map()),
      J(this, "name", St),
      J(this, "version", Ot),
      J(this, "initialized", !1),
      J(this, "storagePrefix", W),
      J(this, "init", async () => {
        if (!this.initialized) {
      ...
      J(this, "has", (i) => (this.isInitialized(), this.keychain.has(i))),
      J(this, "set", async (i, s) => {
      ...
      J(this, "get", (i) => {
        ...
        if (typeof s > "u") {
          const { message: n } = b("NO_MATCHING_KEY", `${this.name}: ${i}`);
          throw new Error(n);
        }
        return s;
      }),
  ...
  async setKeyChain(e) {
    await this.core.storage.setItem(this.storageKey, Ne(e));
  }
  async getKeyChain() {
    const e = await this.core.storage.getItem(this.storageKey);
    return typeof e < "u" ? $e(e) : void 0;
  }
  async persist() {
...
var zn = Object.defineProperty,
  Ln = (r, e, t) =>
    e in r
      ? zn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  x = (r, e, t) => Ln(r, typeof e != "symbol" ? e + "" : e, t);
class Ei {
  constructor(e, t, i) {
    (this.core = e),
      (this.logger = t),
      x(this, "name", Ct),
      x(this, "keychain"),
      x(this, "randomSessionIdentifier", ze()),
      x(this, "initialized", !1),
      x(this, "init", async () => {
        this.initialized ||
          (await this.keychain.init(), (this.initialized = !0));
      }),
      x(this, "hasKeys", (s) => (this.isInitialized(), this.keychain.has(s))),
      x(this, "getClientId", async () => {
        this.isInitialized();
        const s = await this.getClientSeed(),
          n = Ie.generateKeyPair(s);
        return Ie.encodeIss(n.publicKey);
      }),
      ...
      x(this, "signJWT", async (s) => {
        ...
        const n = await this.getClientSeed(),
          o = Ie.generateKeyPair(n),
          a = this.randomSessionIdentifier,
          c = Pt;
        return await Ie.signJWT(a, s, c, o);
      }),
      ...
      x(this, "encode", async (s, n, o) => {
        ...
        const a = ms(o),
          c = gs(n);
        if (at(a)) return fs(c, o?.encoding);
        if (ct(a)) {
      ...
      x(this, "decode", async (s, n, o) => {
        ...
        try {
          const c = this.getSymKey(s),
            h = _s({ symKey: c, encoded: n, encoding: o?.encoding });
          return nt(h);
        } catch (c) {
          this.logger.error(
      ...
      x(this, "getPayloadType", (s, n = lt) => {
        const o = ht({ encoded: s, encoding: n });
        return Es(o.type);
      }),
      x(this, "getPayloadSenderPublicKey", (s, n = lt) => {
        const o = ht({ encoded: s, encoding: n });
        return o.senderPublicKey ? Vs(o.senderPublicKey, Is) : void 0;
      }),
      (this.core = e),
      (this.logger = j(t, this.name)),
      (this.keychain = i || new _i(this.core, this.logger));
  }
  get context() {
    return B(this.logger);
  }
  ...
  async getClientSeed() {
    ...
    try {
      ...
      (e = ze()), await this.keychain.set(Me, e);
    }
    return xn(e, "base16");
  }
  getSymKey(e) {
...
var kn = Object.defineProperty,
  ...
  We = (r, e, t) =>
    e in r
      ? kn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  Kn = (r, e) => {
  ...
  Bn = (r, e) => jn(r, Un(e)),
  K = (r, e, t) => We(r, typeof e != "symbol" ? e + "" : e, t);
class Ti extends ts {
  constructor(e, t) {
    super(e, t),
      (this.logger = e),
  ...
  async setRelayerMessagesWithoutClientAck(e) {
    await this.core.storage.setItem(this.storageKeyWithoutClientAck, Ne(e));
  }
...
var Vn = Object.defineProperty,
  ...
  Pi = (r, e) => qn(r, Gn(e)),
  G = (r, e, t) => He(r, typeof e != "symbol" ? e + "" : e, t);
class Yn extends is {
  constructor(e, t) {
    super(e, t),
      (this.relayer = e),
      (this.logger = t),
      G(this, "events", new ie()),
      G(this, "name", Nt),
      G(this, "queue", new Map()),
      G(this, "publishTimeout", $(st)),
      G(this, "initialPublishTimeout", $(Q * 15)),
      G(this, "needsTransportRestart", !1),
      G(this, "publish", async (i, s, n) => {
        var o, a, c, h, l;
        ...
        try {
          ue((o = D.params) == null ? void 0 : o.prompt) &&
            ((a = D.params) == null || delete a.prompt),
            ue((c = D.params) == null ? void 0 : c.tag) &&
              ((h = D.params) == null || delete h.tag);
          const E = new Promise(async (L) => {
            const I = ({ id: T }) => {
              var S;
              ((S = D.id) == null ? void 0 : S.toString()) === T.toString() &&
                (this.removeRequestFromQueue(T),
                this.relayer.events.removeListener(C.publish, I),
                L());
            };
            ...
            const k = H(
              ...
              `Failed initial publish, retrying.... id:${u} tag:${w}`
            );
            try {
              await k, this.events.removeListener(C.publish, I);
            } catch (T) {
              this.queue.set(u, { request: D, opts: n, attempt: 1 }),
          ...
          this.logger.trace({
            type: "method",
            method: "publish",
            params: { id: u, topic: i, message: s, opts: n },
          }),
            await H(E, this.publishTimeout, _);
        } catch (E) {
          if (
            (this.logger.debug("Failed to Publish Payload"),
            this.logger.error(E),
            (l = n?.internal) != null && l.throwOnFailedPublish)
          )
            throw E;
        } finally {
          this.queue.delete(u);
      ...
      G(this, "publishCustom", async (i) => {
        ...
        const { payload: h, opts: l = {} } = i,
          ...
          I = {
            ...
            method: L,
            params: ce(
              Pi(ce({}, h), { ttl: D, prompt: u, tag: m, attestation: p }),
              y
            ),
          },
          k = `Failed to publish custom payload, please try again. id:${_} tag:${m}`;
        try {
          ue((s = I.params) == null ? void 0 : s.prompt) &&
            ((n = I.params) == null || delete n.prompt),
            ue((o = I.params) == null ? void 0 : o.tag) &&
              ((a = I.params) == null || delete a.tag);
          const T = new Promise(async (S) => {
            const O = ({ id: Z }) => {
              var _e;
              ((_e = I.id) == null ? void 0 : _e.toString()) === Z.toString() &&
                (this.removeRequestFromQueue(Z),
                this.relayer.events.removeListener(C.publish, O),
                S());
            };
            ...
            const te = H(
              ...
              this.initialPublishTimeout,
              `Failed initial custom payload publish, retrying.... method:${L} id:${_} tag:${m}`
            );
            try {
              await te, this.events.removeListener(C.publish, O);
            } catch (Z) {
              this.queue.set(_, { request: I, opts: l, attempt: 1 }),
          ...
          this.logger.trace({
            type: "method",
            method: "publish",
            params: { id: _, payload: h, opts: l },
          }),
            await H(T, this.publishTimeout, k);
        } catch (T) {
          if (
            (this.logger.debug("Failed to Publish Payload"),
            this.logger.error(T),
            (c = l?.internal) != null && c.throwOnFailedPublish)
          )
            throw T;
        } finally {
          this.queue.delete(_);
  ...
  async rpcPublish(e, t) {
    ...
    return (
      this.relayer.events.emit(C.publish, ce(ce({}, e), t)),
  ...
  checkQueue() {
    this.queue.forEach(async (e, t) => {
      var i;
      const s = e.attempt + 1;
      this.queue.set(t, Pi(ce({}, e), { attempt: s })),
        this.logger.warn(
          {},
          `Publisher: queue->publishing: ${e.request.id}, tag: ${
            (i = e.request.params) == null ? void 0 : i.tag
          }, attempt: ${s}`
        ),
  ...
  registerEventListeners() {
    this.relayer.core.heartbeat.on(se.pulse, () => {
...
var Jn = Object.defineProperty,
  Xn = (r, e, t) =>
    e in r
      ? Jn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  he = (r, e, t) => Xn(r, typeof e != "symbol" ? e + "" : e, t);
class Zn {
  constructor() {
    he(this, "map", new Map()),
      he(this, "set", (e, t) => {
      ...
      he(this, "get", (e) => this.map.get(e) || []),
      he(this, "exists", (e, t) => this.get(e).includes(t)),
      he(this, "delete", (e, t) => {
        if (typeof t > "u") {
          this.map.delete(e);
          return;
...
var Qn = Object.defineProperty,
  ...
  Ye = (r, e, t) =>
    e in r
      ? Qn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  fe = (r, e) => {
  ...
  Je = (r, e) => eo(r, to(e)),
  f = (r, e, t) => Ye(r, typeof e != "symbol" ? e + "" : e, t);
class Oi extends ss {
  constructor(e, t) {
    super(e, t),
      (this.relayer = e),
      (this.logger = t),
      f(this, "subscriptions", new Map()),
      f(this, "topicMap", new Zn()),
      f(this, "events", new ie()),
      f(this, "name", Mt),
      f(this, "version", Kt),
      f(this, "pending", new Map()),
      f(this, "cached", []),
      f(this, "initialized", !1),
      f(this, "storagePrefix", W),
      f(this, "subscribeTimeout", $(st)),
      f(this, "initialSubscribeTimeout", $(Q * 15)),
      f(this, "clientId"),
      f(this, "batchSubscribeTopicsLimit", 500),
      f(this, "init", async () => {
        this.initialized ||
          (this.logger.trace("Initialized"),
          this.registerEventListeners(),
      ...
      f(this, "subscribe", async (i, s) => {
        ...
        try {
          const o = Ce(s),
            a = { topic: i, relay: o, transportType: s?.transportType };
          ((n = s?.internal) != null && n.skipSubscribe) ||
      ...
      f(this, "registerEventListeners", () => {
        this.relayer.core.heartbeat.on(se.pulse, async () => {
  ...
  async unsubscribeById(e, t, i) {
    ...
    try {
      ...
      const n = de("USER_DISCONNECTED", `${this.name}, ${e}`);
  ...
  async rpcSubscribe(e, t, i) {
    ...
    try {
      ...
      const h = new Promise(async (p) => {
          const y = (w) => {
            w.topic === e &&
              (this.events.removeListener(U.created, y), p(w.id));
          };
  ...
  async rpcBatchSubscribe(e) {
    ...
    const t = e[0].relay,
      i = {
        method: ne(t.protocol).batchSubscribe,
  ...
  async rpcBatchFetchMessages(e) {
    ...
    const t = e[0].relay,
      i = {
        method: ne(t.protocol).batchFetchMessages,
  ...
  rpcUnsubscribe(e, t, i) {
    const s = {
      method: ne(i.protocol).unsubscribe,
      params: { topic: e, id: t },
    };
    return (
      this.logger.debug("Outgoing Relay Payload"),
  ...
  onSubscribe(e, t) {
    this.setSubscription(e, Je(fe({}, t), { id: e })),
  ...
  addSubscription(e, t) {
    this.subscriptions.set(e, fe({}, t)),
      this.topicMap.set(t.topic, e),
      this.events.emit(U.created, t);
  }
  getSubscription(e) {
    ...
    if (!t) {
      const { message: i } = b("NO_MATCHING_KEY", `${this.name}: ${e}`);
      throw new Error(i);
    }
    return t;
  }
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e),
      ...
      this.events.emit(U.deleted, Je(fe({}, i), { reason: t }));
  }
  async persist() {
    ...
    try {
      ...
      if (
        ...
        !e.every((t) => {
          ...
          return (
            t.topic ===
            ((i = this.subscriptions.get(t.id)) == null ? void 0 : i.topic)
          );
        })
      ) {
  ...
  async batchSubscribe(e) {
    e.length &&
      ...
      this.onBatchSubscribe(
        await Promise.all(
          e.map(async (t) =>
            Je(fe({}, t), { id: await this.getSubscriptionId(t.topic) })
          )
        )
      ));
  }
  async batchFetchMessages(e) {
    ...
    t &&
      t.messages &&
      (await Ts($(Q)), await this.relayer.handleBatchMessageEvents(t.messages));
  }
  async onConnect() {
  ...
  async getSubscriptionId(e) {
    return Te(e + (await this.getClientId()));
  }
}
var ro = Object.defineProperty,
  ...
  Xe = (r, e, t) =>
    e in r
      ? ro(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  Ai = (r, e) => {
...
class xi extends rs {
  constructor(e) {
    super(e),
      ...
      g(this, "publisher"),
      g(this, "name", Lt),
      g(this, "transportExplicitlyClosed", !1),
      g(this, "initialized", !1),
      g(this, "connectionAttemptInProgress", !1),
      g(this, "relayUrl"),
      g(this, "projectId"),
      g(this, "packageName"),
      g(this, "bundleId"),
      g(this, "hasExperiencedNetworkDisruption", !1),
      g(this, "pingTimeout"),
      g(this, "heartBeatTimeout", $(xe + Ae)),
      g(this, "reconnectTimeout"),
      g(this, "connectPromise"),
      g(this, "reconnectInProgress", !1),
      g(this, "requestsInFlight", []),
      g(this, "connectTimeout", $(Q * 15)),
      g(this, "request", async (t) => {
        var i, s;
        this.logger.debug("Publishing Request Payload");
        const n = t.id || je().toString();
      ...
      g(this, "onProviderErrorHandler", (t) => {
        this.logger.fatal(`Fatal socket error: ${t.message}`),
          this.events.emit(C.error, t),
          this.logger.fatal("Fatal socket error received, closing transport"),
          this.transportClose();
      }),
      g(this, "registerProviderListeners", () => {
        this.provider.on(M.payload, this.onPayloadHandler),
          this.provider.on(M.connect, this.onConnectHandler),
          this.provider.on(M.disconnect, this.onDisconnectHandler),
          this.provider.on(M.error, this.onProviderErrorHandler);
      }),
      (this.core = e.core),
      (this.logger =
        typeof e.logger < "u" && typeof e.logger != "string"
          ? j(e.logger, this.name)
          : Qi(it({ level: e.logger || zt }))),
      (this.messages = new Ti(this.logger, e.core)),
      (this.subscriber = new Oi(this, this.logger)),
      (this.publisher = new Yn(this, this.logger)),
      (this.projectId = e?.projectId),
      (this.relayUrl = e?.relayUrl || Ke),
      Cs() ? (this.packageName = ut()) : Ps() && (this.bundleId = ut()),
      (this.provider = {});
  }
  async init() {
    this.logger.trace("Initialized"),
  ...
  async subscribe(e, t) {
    var i, s, n;
    this.isInitialized(),
      (!(t != null && t.transportType) || t?.transportType === "relay") &&
        (await this.toEstablishConnection());
    const o =
      typeof ((i = t?.internal) == null ? void 0 : i.throwOnFailedPublish) > "u"
        ? !0
        : (s = t?.internal) == null
        ? void 0
        ...
        new Promise(async (l, p) => {
          (a =
            (await this.subscriber
              .subscribe(e, Ai({ internal: { throwOnFailedPublish: o } }, t))
              .catch((y) => {
                o && p(y);
              })) || a),
            l();
  ...
  async transportDisconnect() {
    ...
    (this.hasExperiencedNetworkDisruption || this.connected)
      ? await H(this.provider.disconnect(), 2e3, "provider.disconnect()").catch(
          () => this.onProviderDisconnect()
        )
      : this.onProviderDisconnect();
  }
  ...
  async onLinkMessageEvent(e, t) {
    ...
    this.events.emit(C.message, e),
      await this.recordMessageEvent(e, ye.inbound);
  }
  async connect(e) {
    await this.confirmOnlineStateOrThrow(),
      e &&
    ...
    for (; t < 6; ) {
      try {
        ...
        this.logger.debug(
          ...
          await new Promise(async (i, s) => {
            ...
            this.provider.once(M.disconnect, n),
              await H(
                new Promise((o, a) => {
                ...
                .finally(() => {
                  this.provider.off(M.disconnect, n),
              ...
              await new Promise(async (o, a) => {
                ...
                this.provider.once(M.disconnect, c),
                  await this.subscriber
                    .start()
                    .then(o)
                    .catch(a)
      ...
      await new Promise((i) => setTimeout(i, $(t * 1))), t++;
    }
  }
  startPingTimeout() {
    var e, t, i, s, n;
  ...
  async onProviderPayload(e) {
    if (
      ...
      this.logger.debug("Emitting Relayer Payload"),
        this.logger.trace(Ai({ type: "event", event: t.id }, a)),
        this.events.emit(t.id, a),
        await this.acknowledgePayload(e),
        await this.onMessageEvent(a);
    } else vt(e) && this.events.emit(C.message_ack, e);
  }
  ...
  unregisterProviderListeners() {
    this.provider.off(M.payload, this.onPayloadHandler),
      this.provider.off(M.connect, this.onConnectHandler),
      this.provider.off(M.disconnect, this.onDisconnectHandler),
      this.provider.off(M.error, this.onProviderErrorHandler),
      clearTimeout(this.pingTimeout);
  }
  async registerEventListeners() {
    ...
    Os(async (t) => {
      ...
      this.core.heartbeat.on(se.pulse, async () => {
        if (!this.transportExplicitlyClosed && !this.connected && Rs())
          try {
...
const co = "[object RegExp]",
  ...
  Co = "[object BigUint64Array]",
  Po = "[object Int8Array]",
  So = "[object Int16Array]",
  Oo = "[object Int32Array]",
  Ro = "[object BigInt64Array]",
    ...
    switch (s) {
      case yo: {
        ...
        for (const [c, h] of r.entries())
          if (!e.has(c) || !De(h, e.get(c), c, r, e, t, i)) return !1;
        return !0;
      }
      case bo: {
        if (r.size !== e.size) return !1;
        ...
        for (let l = 0; l < c.length; l++) {
          const p = c[l],
            y = h.findIndex((w) => De(p, w, void 0, r, e, t, i));
          if (y === -1) return !1;
          h.splice(y, 1);
        }
        return !0;
      ...
      case xo: {
        if (
          ...
          return !1;
        for (let c = 0; c < r.length; c++)
          if (!De(r[c], e[c], c, r, e, t, i)) return !1;
        return !0;
      }
      case Do:
        return r.byteLength !== e.byteLength
          ? !1
          : ve(new Uint8Array(r), new Uint8Array(e), t, i);
      case wo:
      ...
      case Ze: {
        if (!(ve(r.constructor, e.constructor, t, i) || (Li(r) && Li(e))))
          return !1;
        const h = [...Object.keys(r), ...Ni(r)],
          l = [...Object.keys(e), ...Ni(e)];
...
var Lo = Object.defineProperty,
  ...
  Qe = (r, e, t) =>
    e in r
      ? Lo(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  ji = (r, e) => {
...
class Ui extends ns {
  constructor(e, t, i, s = W, n = void 0) {
    super(e, t, i, s),
      ...
      F(this, "getKey"),
      F(this, "storagePrefix", W),
      F(this, "recentlyDeleted", []),
      F(this, "recentlyDeletedLimit", 200),
      F(this, "init", async () => {
        this.initialized ||
          (this.logger.trace("Initialized"),
          await this.restore(),
          this.cached.forEach((o) => {
            this.getKey && o !== null && !ue(o)
              ? this.map.set(this.getKey(o), o)
              : As(o)
              ? this.map.set(o.id, o)
              : xs(o) && this.map.set(o.topic, o);
          }),
          (this.cached = []),
          (this.initialized = !0));
      }),
        ...
        (o) => (
          ...
          o
            ? this.values.filter((a) =>
                Object.keys(o).every((c) => zo(a[c], o[c]))
              )
            : this.values
        )
      ),
      F(this, "update", async (o, a) => {
        this.isInitialized(),
...
var Uo = Object.defineProperty,
  Fo = (r, e, t) =>
    e in r
      ? Uo(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  d = (r, e, t) => Fo(r, typeof e != "symbol" ? e + "" : e, t);
class Fi {
  constructor(e, t) {
    (this.core = e),
      (this.logger = t),
      d(this, "name", Bt),
      d(this, "version", Vt),
      d(this, "events", new Ji()),
      d(this, "pairings"),
      d(this, "initialized", !1),
      d(this, "storagePrefix", W),
      d(this, "ignoredPayloadTypes", [$s]),
      d(this, "registeredMethods", []),
      d(this, "init", async () => {
        this.initialized ||
      ...
      d(this, "pair", async (i) => {
        ...
        const s = this.core.eventClient.createEvent({
          properties: { topic: i?.uri, trace: [Y.pairing_started] },
        });
        ...
        (s.props.properties.topic = n),
          s.addTrace(Y.pairing_uri_validation_success),
          s.addTrace(Y.pairing_uri_not_expired);
        let l;
        if (this.pairings.keys.includes(n)) {
          if (
            ((l = this.pairings.get(n)),
            s.addTrace(Y.existing_pairing),
            l.active)
          )
            throw (
              (s.setError(X.active_pairing_already_exists),
              new Error(
        ...
        const p = c || ge(le),
          y = { topic: n, relay: a, expiry: p, active: !1, methods: h };
        this.core.expirer.set(n, p),
          await this.pairings.set(n, y),
          s.addTrace(Y.store_new_pairing),
          i.activatePairing && (await this.activate({ topic: n })),
          this.events.emit(ae.create, y),
          s.addTrace(Y.emit_inactive_pairing),
          this.core.crypto.keychain.has(n) ||
            (await this.core.crypto.setSymKey(o, n)),
          s.addTrace(Y.subscribing_pairing_topic);
        try {
      ...
      d(this, "ping", async (i) => {
        ...
        if (this.pairings.keys.includes(s)) {
          const n = await this.sendRequest(s, "wc_pairingPing", {}),
            { done: o, resolve: a, reject: c } = zs();
          this.events.once(Le("pairing_ping", n), ({ error: h }) => {
            h ? c(h) : a();
          }),
            await o();
        }
      ...
      d(this, "sendRequest", async (i, s, n) => {
        const o = _t(s, n),
          ...
          c = oe[s].req;
        return (
          this.core.history.set(i, o), this.core.relayer.publish(i, a, c), o.id
        );
      }),
      d(this, "sendResult", async (i, s, n) => {
        const o = wt(i, n),
          ...
          h = oe[c].res;
        await this.core.relayer.publish(s, a, h),
      ...
      d(this, "sendError", async (i, s, n) => {
        const o = Gs(i, n),
          a = await this.core.crypto.encode(s, o),
          c = (await this.core.history.get(s, i)).request.method,
          h = oe[c] ? oe[c].res : oe.unregistered_method.res;
        await this.core.relayer.publish(s, a, h),
          await this.core.history.resolve(o);
      }),
      d(this, "deletePairing", async (i, s) => {
        await this.core.relayer.unsubscribe(i),
          await Promise.all([
            this.pairings.delete(i, de("USER_DISCONNECTED")),
            this.core.crypto.deleteSymKey(i),
            s ? Promise.resolve() : this.core.expirer.del(i),
          ]);
      }),
      d(this, "cleanup", async () => {
        const i = this.pairings.getAll().filter((s) => bt(s.expiry));
      ...
      d(this, "onPairingPingRequest", async (i, s) => {
        ...
        try {
          this.isValidPing({ topic: i }),
            ...
            this.events.emit(ae.ping, { id: n, topic: i });
        } catch (o) {
      ...
      d(this, "onPairingPingResponse", (i, s) => {
        ...
        setTimeout(() => {
          Ws(s)
            ? this.events.emit(Le("pairing_ping", n), {})
            : Et(s) &&
              this.events.emit(Le("pairing_ping", n), { error: s.error });
        }, 500);
      }),
      d(this, "onPairingDeleteRequest", async (i, s) => {
        ...
        try {
          this.isValidDisconnect({ topic: i }),
            ...
            this.events.emit(ae.delete, { id: n, topic: i });
        } catch (o) {
          await this.sendError(n, i, o), this.logger.error(o);
        }
      }),
      d(this, "onUnknownRpcMethodRequest", async (i, s) => {
        ...
        try {
          ...
          const a = de("WC_METHOD_UNSUPPORTED", o);
      ...
      d(this, "onUnknownRpcMethodResponse", (i) => {
        this.registeredMethods.includes(i) ||
          this.logger.error(de("WC_METHOD_UNSUPPORTED", i));
      }),
      d(this, "isValidPair", (i, s) => {
        var n;
        if (!ke(i)) {
          const { message: a } = b("MISSING_OR_INVALID", `pair() params: ${i}`);
        ...
        if (!(o != null && o.symKey)) {
          const { message: a } = b("MISSING_OR_INVALID", "pair() uri#symKey");
          throw (s.setError(X.malformed_pairing_uri), new Error(a));
        }
        if (
          o != null &&
          o.expiryTimestamp &&
          $(o?.expiryTimestamp) < Date.now()
        ) {
      ...
      d(this, "isValidPing", async (i) => {
        if (!ke(i)) {
          const { message: n } = b("MISSING_OR_INVALID", `ping() params: ${i}`);
          throw new Error(n);
        }
        const { topic: s } = i;
      ...
      d(this, "isValidPairingTopic", async (i) => {
        ...
        if (bt(this.pairings.get(i).expiry)) {
          await this.deletePairing(i);
          const { message: s } = b("EXPIRED", `pairing topic: ${i}`);
          throw new Error(s);
        }
      }),
      (this.core = e),
      (this.logger = j(t, this.name)),
      (this.pairings = new Ui(
        this.core,
        this.logger,
        this.name,
        this.storagePrefix
        ...
        try {
          ...
          Dt(n)
            ? (this.core.history.set(t, n),
              await this.onRelayEventRequest({ topic: t, payload: n }))
            : vt(n) &&
  ...
  registerExpirerEvents() {
    this.core.expirer.on(q.expired, async (e) => {
      const { topic: t } = Ns(e.target);
      t &&
        this.pairings.keys.includes(t) &&
        (await this.deletePairing(t, !0),
        this.events.emit(ae.expire, { topic: t }));
    });
  }
}
var Mo = Object.defineProperty,
  Ko = (r, e, t) =>
    e in r
      ? Mo(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  N = (r, e, t) => Ko(r, typeof e != "symbol" ? e + "" : e, t);
class Mi extends os {
  constructor(e, t) {
    super(e, t),
      (this.core = e),
      (this.logger = t),
      N(this, "records", new Map()),
      N(this, "events", new ie()),
      N(this, "name", qt),
      N(this, "version", Gt),
      N(this, "cached", []),
      N(this, "initialized", !1),
      N(this, "storagePrefix", W),
      N(this, "init", async () => {
        this.initialized ||
          (this.logger.trace("Initialized"),
          await this.restore(),
      ...
      N(this, "resolve", async (i) => {
        ...
        typeof s.response > "u" &&
          ((s.response = Et(i) ? { error: i.error } : { result: i.result }),
          this.records.set(s.id, s),
          this.persist(),
          this.events.emit(V.updated, s));
      }),
      N(
        this,
        "get",
  ...
  get pending() {
    ...
    return (
      this.values.forEach((t) => {
        ...
        const i = {
          topic: t.topic,
          request: _t(t.request.method, t.request.params, t.id),
          chainId: t.chainId,
        };
        return e.push(i);
      }),
...
var Bo = Object.defineProperty,
  Vo = (r, e, t) =>
    e in r
      ...
      : (r[e] = t),
  z = (r, e, t) => Vo(r, typeof e != "symbol" ? e + "" : e, t);
class Ki extends as {
  constructor(e, t) {
    super(e, t),
      (this.core = e),
      (this.logger = t),
      z(this, "expirations", new Map()),
      z(this, "events", new ie()),
      z(this, "name", Wt),
      z(this, "version", Ht),
      z(this, "cached", []),
      z(this, "initialized", !1),
      z(this, "storagePrefix", W),
      z(this, "init", async () => {
        this.initialized ||
          (this.logger.trace("Initialized"),
          await this.restore(),
      ...
      z(this, "set", (i, s) => {
        ...
        this.expirations.set(n, o),
          ...
          this.events.emit(q.created, { target: n, expiration: o });
      }),
      z(this, "get", (i) => {
        this.isInitialized();
        const s = this.formatTarget(i);
      ...
      z(this, "del", (i) => {
        if ((this.isInitialized(), this.has(i))) {
          ...
          this.expirations.delete(s),
            this.events.emit(q.deleted, { target: s, expiration: n });
        }
      }),
      z(this, "on", (i, s) => {
        this.events.on(i, s);
  ...
  checkExpiry(e, t) {
    const { expiry: i } = t;
    $(i) - Date.now() <= 0 && this.expire(e, t);
  }
  expire(e, t) {
    this.expirations.delete(e),
      this.events.emit(q.expired, { target: e, expiration: t });
  }
  checkExpirations() {
  ...
  registerEventListeners() {
    this.core.heartbeat.on(se.pulse, () => this.checkExpirations()),
      this.events.on(q.created, (e) => {
        const t = q.created;
        this.logger.info(`Emitting ${t}`),
...
var qo = Object.defineProperty,
  Go = (r, e, t) =>
    e in r
      ? qo(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  P = (r, e, t) => Go(r, typeof e != "symbol" ? e + "" : e, t);
class Bi extends cs {
  constructor(e, t, i) {
    super(e, t, i),
      (this.core = e),
      ...
      P(this, "isDevEnv"),
      P(this, "verifyUrlV3", Xt),
      P(this, "storagePrefix", W),
      P(this, "version", Fe),
      P(this, "publicKey"),
      P(this, "fetchPromise"),
      P(this, "init", async () => {
          ...
          const h = Ys(),
            ...
            p = await new Promise((y, w) => {
              ...
              (m.src = c),
                ...
                m.addEventListener("error", u, {
                  signal: this.abortController.signal,
                });
              const D = (_) => {
                if (_.data && typeof _.data == "string")
                  try {
                    const E = JSON.parse(_.data);
                    if (E.type === "verify_attestation") {
                      if (ot(E.attestation).payload.id !== o) return;
                      clearInterval(l),
                        h.body.removeChild(m),
                        ...
                        window.removeEventListener("message", D),
                        y(E.attestation === null ? "" : E.attestation);
                    }
                  } catch (E) {
                    this.logger.warn(E);
                  }
      ...
      P(this, "fetchAttestation", async (s, n) => {
        ...
        const o = this.startAbortTimer(Q * 5),
      ...
      P(this, "getVerifyUrl", (s) => {
        ...
        return (
          Zt.includes(n) ||
            (this.logger.info(
              `verify url: ${n}, not included in trusted list, assigning default: ${be}`
            ),
            (n = be)),
          n
        );
      ...
      P(this, "fetchPublicKey", async () => {
        try {
          ...
          const s = this.startAbortTimer(Ae),
      ...
      P(this, "validateAttestation", (s, n) => {
        const o = Ms(s, n.publicKey),
          a = { hasExpired: $(o.exp) < Date.now(), payload: o };
        if (a.hasExpired)
          throw (
  ...
  startAbortTimer(e) {
    return (
      (this.abortController = new AbortController()),
      setTimeout(() => this.abortController.abort(), $(e))
    );
  }
}
var Wo = Object.defineProperty,
  Ho = (r, e, t) =>
    e in r
      ...
      : (r[e] = t),
  Vi = (r, e, t) => Ho(r, typeof e != "symbol" ? e + "" : e, t);
class qi extends hs {
  constructor(e, t) {
    super(e, t),
      (this.projectId = e),
      (this.logger = t),
      Vi(this, "context", Qt),
      Vi(this, "registerDeviceToken", async (i) => {
        const {
            clientId: s,
            token: n,
            notificationType: o,
...
var Yo = Object.defineProperty,
  ...
  et = (r, e, t) =>
    e in r
      ? Yo(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (r[e] = t),
  we = (r, e) => {
...
class Wi extends ls {
  constructor(e, t, i = !0) {
    super(e, t, i),
      ...
      (this.logger = t),
      R(this, "context", ii),
      R(this, "storagePrefix", W),
      R(this, "storageVersion", ti),
      R(this, "events", new Map()),
      R(this, "shouldPersist", !1),
      R(this, "init", async () => {
        if (!mt())
          try {
            const s = {
      ...
      R(this, "createEvent", (s) => {
        ...
        return (
          this.telemetryEnabled &&
            (this.events.set(h, y), (this.shouldPersist = !0)),
          y
        );
      }),
      R(this, "getEvent", (s) => {
      ...
      R(this, "restore", async () => {
        try {
          ...
          s.forEach((n) => {
            this.events.set(
              n.eventId,
              we(we({}, n), this.setMethods(n.eventId))
            );
          });
        } catch (s) {
          this.logger.warn(s);
      ...
      R(this, "sendEvent", async (s) => {
        ...
        return await fetch(
          `${ri}?projectId=${this.core.projectId}&st=events_sdk&sv=js-${Pe}${n}`,
          { method: "POST", body: JSON.stringify(s) }
        );
      }),
      R(this, "getAppDomain", () => Bs().url),
      (this.logger = j(t, this.context)),
...
class Oe extends us {
  constructor(e) {
    ...
    super(e),
      ...
      v(this, "on", (a, c) => this.events.on(a, c)),
      v(this, "once", (a, c) => this.events.once(a, c)),
      v(this, "off", (a, c) => this.events.off(a, c)),
      v(this, "removeListener", (a, c) => this.events.removeListener(a, c)),
      v(
        this,
        "dispatchEnvelope",
        ({ topic: a, message: c, sessionExists: h }) => {
          if (!a || !c) return;
          const l = {
            topic: a,
            message: c,
    ...
    const s = it({
      ...
      { logger: n, chunkLoggerController: o } = es({
        opts: s,
    ...
    (this.logChunkController = o),
      ...
      (this.logger = j(n, this.name)),
      (this.heartbeat = new Xi()),
      (this.crypto = new Ei(this, this.logger, e?.keychain)),
      (this.history = new Mi(this, this.logger)),
      (this.expirer = new Ki(this, this.logger)),
      (this.storage =
        e != null && e.storage
          ? e.storage
          : new Zi(Yi(Yi({}, Tt), e?.storageOptions))),
      (this.relayer = new xi({
        core: this,
        logger: this.logger,
        relayUrl: this.relayUrl,
      ...
      (this.verify = new Bi(this, this.logger, this.storage)),
      (this.echoClient = new qi(this.projectId || "", this.logger)),
      (this.linkModeSupportedApps = []),
      (this.eventClient = new Wi(this, this.logger, e?.telemetryEnabled)),
  ...
  async addLinkModeSupportedApp(e) {
    this.linkModeSupportedApps.includes(e) ||
      ...
      await this.storage.setItem(Be, this.linkModeSupportedApps));
  }
  async initialize() {
    this.logger.trace("Initialized");
    try {
      await this.crypto.init(),
        ...
        (this.linkModeSupportedApps = (await this.storage.getItem(Be)) || []),
        (this.initialized = !0),
...
export {
  ...
  It as CORE_DEFAULT,
  Ue as CORE_PROTOCOL,
  Tt as CORE_STORAGE_OPTIONS,
  W as CORE_STORAGE_PREFIX,
  Fe as CORE_VERSION,
  Me as CRYPTO_CLIENT_SEED,
  Ct as CRYPTO_CONTEXT,
  Pt as CRYPTO_JWT_TTL,
  ta as Core,
  Ei as Crypto,
  Qt as ECHO_CONTEXT,
  ei as ECHO_URL,
  ri as EVENTS_CLIENT_API_URL,
  si as EVENTS_STORAGE_CLEANUP_INTERVAL,
  ii as EVENTS_STORAGE_CONTEXT,
  ti as EVENTS_STORAGE_VERSION,
  ar as EVENT_CLIENT_AUTHENTICATE_ERRORS,
  or as EVENT_CLIENT_AUTHENTICATE_TRACES,
  sr as EVENT_CLIENT_CONTEXT,
  X as EVENT_CLIENT_PAIRING_ERRORS,
  Y as EVENT_CLIENT_PAIRING_TRACES,
  nr as EVENT_CLIENT_SESSION_ERRORS,
  rr as EVENT_CLIENT_SESSION_TRACES,
  Wt as EXPIRER_CONTEXT,
  tr as EXPIRER_DEFAULT_TTL,
  q as EXPIRER_EVENTS,
  Ht as EXPIRER_STORAGE_VERSION,
  qi as EchoClient,
  Wi as EventClient,
  Ki as Expirer,
  qt as HISTORY_CONTEXT,
  V as HISTORY_EVENTS,
  Gt as HISTORY_STORAGE_VERSION,
  Mi as JsonRpcHistory,
  St as KEYCHAIN_CONTEXT,
  Ot as KEYCHAIN_STORAGE_VERSION,
  _i as KeyChain,
  Rt as MESSAGES_CONTEXT,
  At as MESSAGES_STORAGE_VERSION,
  ye as MESSAGE_DIRECTION,
  Ti as MessageTracker,
  Bt as PAIRING_CONTEXT,
  er as PAIRING_DEFAULT_TTL,
  ae as PAIRING_EVENTS,
  oe as PAIRING_RPC_OPTS,
  Vt as PAIRING_STORAGE_VERSION,
  Qs as PENDING_SUB_RESOLUTION_TIMEOUT,
  Nt as PUBLISHER_CONTEXT,
  xt as PUBLISHER_DEFAULT_TTL,
  Fi as Pairing,
  Lt as RELAYER_CONTEXT,
  zt as RELAYER_DEFAULT_LOGGER,
  $t as RELAYER_DEFAULT_PROTOCOL,
  Ke as RELAYER_DEFAULT_RELAY_URL,
  C as RELAYER_EVENTS,
  M as RELAYER_PROVIDER_EVENTS,
  jt as RELAYER_RECONNECT_TIMEOUT,
  Pe as RELAYER_SDK_VERSION,
  Js as RELAYER_STORAGE_OPTIONS,
  kt as RELAYER_SUBSCRIBER_SUFFIX,
  Xs as RELAYER_TRANSPORT_CUTOFF,
  xi as Relayer,
  Ut as STORE_STORAGE_VERSION,
  Mt as SUBSCRIBER_CONTEXT,
  Zs as SUBSCRIBER_DEFAULT_TTL,
  U as SUBSCRIBER_EVENTS,
  Kt as SUBSCRIBER_STORAGE_VERSION,
  Ui as Store,
  Oi as Subscriber,
  ee as TRANSPORT_TYPES,
  Zt as TRUSTED_VERIFY_URLS,
  Yt as VERIFY_CONTEXT,
  be as VERIFY_SERVER,
  Xt as VERIFY_SERVER_V3,
  Bi as Verify,
  Ft as WALLETCONNECT_CLIENT_ID,
  Be as WALLETCONNECT_LINK_MODE_APPS,
  Oe as default,
};
