import qt from "@walletconnect/sign-client";
import {
  isValidObject as R,
  isCaipNamespace as et,
  parseNamespaceKey as _,
  mergeArrays as J,
  parseChainId as z,
  getSdkError as st,
  isValidArray as k,
...
import {
  pino as jt,
  getDefaultLoggerOptions as Rt,
} from "@walletconnect/logger";
import g, {
  HttpConnection as _t,
} from "@walletconnect/jsonrpc-http-connection";
import { JsonRpcProvider as m } from "@walletconnect/jsonrpc-provider";
import {
  formatJsonRpcRequest as Ft,
  formatJsonRpcResult as Ut,
} from "@walletconnect/jsonrpc-utils";
import xt from "events";
const it = "error",
  Lt = "wss://relay.walletconnect.org",
  Mt = "wc",
  Bt = "universal_provider",
  F = `${Mt}@2:${Bt}:`,
  rt = "https://rpc.walletconnect.org/v1/",
  nt = "generic",
  Gt = `${rt}bundler`,
  l = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
function W(s) {
  return s == null || (typeof s != "object" && typeof s != "function");
}
function at(s) {
  return Object.getOwnPropertySymbols(s).filter((t) =>
    Object.prototype.propertyIsEnumerable.call(s, t)
  );
}
function ct(s) {
  return s == null
...
function I(s, t, e, i = new Map(), n = void 0) {
  ...
  if (Array.isArray(s)) {
    ...
    return (
      Object.hasOwn(s, "index") && (r.index = s.index),
      Object.hasOwn(s, "input") && (r.input = s.input),
      r
    );
  }
      ...
      switch (Object.prototype.toString.call(s)) {
        ...
        case dt: {
          ...
          return (
            y(c, s),
            (c.length = s.length),
            (c[Symbol.iterator] = s[Symbol.iterator]),
            c
          );
        }
        default:
...
function ue(s) {
  ...
  if (Object.prototype.toString.call(s) !== "[object Object]") {
    ...
    return e == null ||
      !Object.getOwnPropertyDescriptor(s, Symbol.toStringTag)?.writable
      ? !1
      : s.toString() === `[object ${e}]`;
  }
  let t = s;
...
function U(s, t, e, i) {
  ...
  for (let a = 0; a < n.length; a++) {
    ...
    if (
      (lt(c) && (c = { ...c }),
      lt(o) && (o = { ...o }),
      typeof Buffer < "u" && Buffer.isBuffer(c) && (c = ut(c)),
      Array.isArray(c))
    )
    ...
    p != null
      ? (s[r] = p)
      : Array.isArray(c) || (ft(o) && ft(c))
      ? (s[r] = U(o, c, e, i))
      : o == null && ue(c)
      ? (s[r] = U({}, c, e, i))
      : o == null && de(c)
      ? (s[r] = ut(c))
      : (o === void 0 || c !== void 0) && (s[r] = c);
  }
  return s;
}
function me(s, ...t) {
...
var ve = Object.defineProperty,
  ...
  vt = (s, t, e) =>
    t in s
      ? ve(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  x = (s, t) => {
...
function u(s, t, e) {
  ...
  const n = z(s);
  return (
    ((i = t.rpcMap) == null ? void 0 : i[n.reference]) ||
    `${rt}?chainId=${n.namespace}:${n.reference}&projectId=${e}`
  );
}
function b(s) {
...
function Pt(s) {
  return Object.fromEntries(
    Object.entries(s).filter(([t, e]) => {
      var i, n;
      return (
        ((i = e?.chains) == null ? void 0 : i.length) &&
        ((n = e?.chains) == null ? void 0 : n.length) > 0
      );
    })
  );
}
...
function wt(s) {
  ...
  for (const [c, o] of Object.entries(s)) {
    const p = et(c) ? [c] : o.chains,
      v = o.methods || [],
      w = o.events || [],
      P = o.rpcMap || {},
      d = _(c);
    (r[d] = be(x(x({}, r[d]), o), {
      chains: J(p, (t = r[d]) == null ? void 0 : t.chains),
      methods: J(v, (e = r[d]) == null ? void 0 : e.methods),
      events: J(w, (i = r[d]) == null ? void 0 : i.events),
    })),
      (R(P) || R(((n = r[d]) == null ? void 0 : n.rpcMap) || {})) &&
        (r[d].rpcMap = x(x({}, P), (a = r[d]) == null ? void 0 : a.rpcMap));
  }
  return r;
}
function yt(s) {
...
function bt(s) {
  ...
  for (const [e, i] of Object.entries(s)) {
    const n = i.methods || [],
      a = i.events || [],
      r = i.accounts || [],
      c = et(e) ? [e] : i.chains ? i.chains : gt(i.accounts);
    t[e] = { chains: c, methods: n, events: a, accounts: r };
  }
  return t;
}
function V(s) {
...
const Ct = "eip155",
  ...
  Ee = (s) => (s && s.startsWith("0x") ? BigInt(s).toString(10) : s),
  Y = (s) => (s && s.startsWith("0x") ? s : `0x${BigInt(s).toString(16)}`),
  Et = (s) =>
    Object.keys(s)
      .filter((t) => Ce.includes(t))
      .reduce((t, e) => ((t[e] = s[e]), t), {}),
  He = (s, t, e) => {
    const { sessionProperties: i = {}, scopedProperties: n = {} } = s,
      a = {};
    if (!R(n) && !R(i)) return;
    const r = Et(i);
    for (const c of e) {
    ...
    for (const [c, o] of Object.entries(a))
      Object.keys(o).length === 0 && delete a[c];
    return Object.keys(a).length > 0 ? a : void 0;
  };
var Ne = Object.defineProperty,
  Se = (s, t, e) =>
    t in s
      ? Ne(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  $ = (s, t, e) => Se(s, typeof t != "symbol" ? t + "" : t, e);
class De {
  constructor(t) {
    $(this, "name", "polkadot"),
      $(this, "client"),
  ...
  setDefaultChain(t, e) {
    this.httpProviders[t] || this.setHttpProvider(t, e),
      (this.chainId = t),
      this.events.emit(l.DEFAULT_CHAIN_CHANGED, `${this.name}:${t}`);
  }
  getAccounts() {
  ...
  createHttpProvider(t, e) {
    ...
    return new m(new g(i, h("disableProviderPing")));
  }
}
var qe = Object.defineProperty,
  ...
  Q = (s, t, e) =>
    t in s
      ? qe(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  Nt = (s, t) => {
  ...
  St = (s, t) => je(s, Re(t)),
  O = (s, t, e) => Q(s, typeof t != "symbol" ? t + "" : t, e);
class Ue {
  constructor(t) {
    O(this, "name", "eip155"),
      O(this, "client"),
  ...
  createHttpProvider(t, e) {
    const i =
      e || u(`${this.name}:${t}`, this.namespace, this.client.core.projectId);
    if (!i) throw new Error(`No RPC url provided for chainId: ${t}`);
    return new m(new _t(i, h("disableProviderPing")));
  }
  setHttpProvider(t, e) {
    const i = this.createHttpProvider(t, e);
    i && (this.httpProviders[t] = i);
  ...
  async getCapabilities(t) {
    var e, i, n, a, r;
    const c =
        (i = (e = t.request) == null ? void 0 : e.params) == null
          ? void 0
          : i[0],
      o =
        ((a = (n = t.request) == null ? void 0 : n.params) == null
          ? void 0
          : a[1]) || [];
    if (!c)
      throw new Error(
    ...
    const p = this.client.session.get(t.topic),
      v = ((r = p?.sessionProperties) == null ? void 0 : r.capabilities) || {},
      w = `${c}${o.join(",")}`,
      P = v?.[w];
    if (P) return P;
    let d;
  ...
  async getCallStatus(t) {
    ...
    const n = this.client.session.get(t.topic),
      a = (e = n.sessionProperties) == null ? void 0 : e.bundler_name;
    if (a) {
  ...
  async getUserOperationReceipt(t, e) {
    ...
    const n = new URL(t),
      a = await fetch(n, {
        ...
        body: JSON.stringify(
          Ft("eth_getUserOperationReceipt", [
...
var xe = Object.defineProperty,
  Le = (s, t, e) =>
    t in s
      ? xe(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  A = (s, t, e) => Le(s, typeof t != "symbol" ? t + "" : t, e);
class Me {
  constructor(t) {
    A(this, "name", "solana"),
      A(this, "client"),
      A(this, "httpProviders"),
      A(this, "events"),
      A(this, "namespace"),
      A(this, "chainId"),
      (this.namespace = t.namespace),
...
var Be = Object.defineProperty,
  Ge = (s, t, e) =>
    t in s
      ? Be(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  C = (s, t, e) => Ge(s, typeof t != "symbol" ? t + "" : t, e);
class Je {
  constructor(t) {
    C(this, "name", "cosmos"),
      C(this, "client"),
...
var ze = Object.defineProperty,
  ke = (s, t, e) =>
    t in s
      ? ze(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  E = (s, t, e) => ke(s, typeof t != "symbol" ? t + "" : t, e);
class We {
  constructor(t) {
    E(this, "name", "algorand"),
      E(this, "client"),
      E(this, "httpProviders"),
      E(this, "events"),
      E(this, "namespace"),
      E(this, "chainId"),
      (this.namespace = t.namespace),
  ...
  createHttpProvider(t, e) {
    const i = e || u(t, this.namespace, this.client.core.projectId);
    return typeof i > "u" ? void 0 : new m(new g(i, h("disableProviderPing")));
  }
}
var Ke = Object.defineProperty,
  Ve = (s, t, e) =>
    t in s
      ? Ke(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  H = (s, t, e) => Ve(s, typeof t != "symbol" ? t + "" : t, e);
class Xe {
  constructor(t) {
    H(this, "name", "cip34"),
      H(this, "client"),
      H(this, "httpProviders"),
      H(this, "events"),
      H(this, "namespace"),
      H(this, "chainId"),
      (this.namespace = t.namespace),
...
var Ye = Object.defineProperty,
  Qe = (s, t, e) =>
    t in s
      ? Ye(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  N = (s, t, e) => Qe(s, typeof t != "symbol" ? t + "" : t, e);
class Ze {
  constructor(t) {
    N(this, "name", "elrond"),
      N(this, "client"),
      N(this, "httpProviders"),
      N(this, "events"),
      N(this, "namespace"),
      N(this, "chainId"),
      (this.namespace = t.namespace),
...
var Te = Object.defineProperty,
  ts = (s, t, e) =>
    t in s
      ? Te(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  S = (s, t, e) => ts(s, typeof t != "symbol" ? t + "" : t, e);
class es {
  constructor(t) {
    S(this, "name", "multiversx"),
      S(this, "client"),
      S(this, "httpProviders"),
      S(this, "events"),
      S(this, "namespace"),
      S(this, "chainId"),
      (this.namespace = t.namespace),
...
var ss = Object.defineProperty,
  is = (s, t, e) =>
    t in s
      ? ss(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  D = (s, t, e) => is(s, typeof t != "symbol" ? t + "" : t, e);
class rs {
  constructor(t) {
    D(this, "name", "near"),
      D(this, "client"),
      D(this, "httpProviders"),
      D(this, "events"),
      D(this, "namespace"),
      D(this, "chainId"),
      (this.namespace = t.namespace),
...
var ns = Object.defineProperty,
  as = (s, t, e) =>
    t in s
      ? ns(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  q = (s, t, e) => as(s, typeof t != "symbol" ? t + "" : t, e);
class cs {
  constructor(t) {
    q(this, "name", "tezos"),
      q(this, "client"),
      q(this, "httpProviders"),
      q(this, "events"),
      q(this, "namespace"),
      q(this, "chainId"),
      (this.namespace = t.namespace),
  ...
  createHttpProvider(t, e) {
    const i = e || u(t, this.namespace);
    return typeof i > "u" ? void 0 : new m(new g(i));
  }
}
var os = Object.defineProperty,
  hs = (s, t, e) =>
    t in s
      ? os(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  j = (s, t, e) => hs(s, typeof t != "symbol" ? t + "" : t, e);
class ps {
  constructor(t) {
    j(this, "name", nt),
      j(this, "client"),
      j(this, "httpProviders"),
      j(this, "events"),
      j(this, "namespace"),
      j(this, "chainId"),
      (this.namespace = t.namespace),
...
var ds = Object.defineProperty,
  ...
  Z = (s, t, e) =>
    t in s
      ? ds(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (s[t] = e),
  M = (s, t) => {
  ...
  T = (s, t) => us(s, ls(t)),
  f = (s, t, e) => Z(s, typeof t != "symbol" ? t + "" : t, e);
class B {
  constructor(t) {
    f(this, "client"),
      f(this, "namespaces"),
      f(this, "optionalNamespaces"),
      f(this, "sessionProperties"),
      f(this, "scopedProperties"),
      f(this, "events", new xt()),
      f(this, "rpcProviders", {}),
      f(this, "session"),
      f(this, "providerOpts"),
      f(this, "logger"),
      f(this, "uri"),
      f(this, "disableProviderPing", !1),
      (this.providerOpts = t),
      (this.logger =
        typeof t?.logger < "u" && typeof t?.logger != "string"
          ? t.logger
          : jt(Rt({ level: t?.logger || it }))),
  ...
  async authenticate(t, e) {
    ...
    if (((this.session = a.session), this.session)) {
      ...
      (this.namespaces = L(this.namespaces, r)),
  ...
  async pair(t) {
    ...
    return (
      (this.namespaces = L(this.namespaces, a)),
      await this.persist("namespaces", this.namespaces),
        ...
        throw (
          ...
          new Error(
            `The provided session: ${
              (e = (t = this.providerOpts) == null ? void 0 : t.session) == null
                ? void 0
                : e.topic
  ...
  createProviders() {
    ...
    const t = [
      ...new Set(Object.keys(this.session.namespaces).map((e) => _(e))),
    ];
    X("client", this.client),
      X("events", this.events),
      X("disableProviderPing", this.disableProviderPing),
      t.forEach((e) => {
        if (!this.session) return;
        const i = Ie(e, this.session);
        if (i?.length === 0) return;
        const n = gt(i),
          a = L(this.namespaces, this.optionalNamespaces),
          r = T(M({}, a[e]), { accounts: i, chains: n });
        switch (e) {
          case "eip155":
            this.rpcProviders[e] = new Ue({ namespace: r });
            break;
          case "algorand":
          ...
          case "cip34":
            ...
            break;
          case "elrond":
            this.rpcProviders[e] = new Ze({ namespace: r });
            break;
          case "multiversx":
            this.rpcProviders[e] = new es({ namespace: r });
            break;
          case "near":
            this.rpcProviders[e] = new rs({ namespace: r });
            break;
          case "tezos":
            this.rpcProviders[e] = new cs({ namespace: r });
            break;
          default:
            this.rpcProviders[e] = new ps({ namespace: r });
        }
      });
  }
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t) => {
      var e;
      const { topic: i } = t;
      i === ((e = this.session) == null ? void 0 : e.topic) &&
      ...
      this.client.on("session_event", (t) => {
        ...
        if (a.name === "accountsChanged") {
          const r = a.data;
          r && k(r) && this.events.emit("accountsChanged", r.map(yt));
      ...
      this.client.on("session_update", ({ topic: t, params: e }) => {
        ...
        const { namespaces: a } = e,
          r = (n = this.client) == null ? void 0 : n.session.get(t);
        (this.session = T(M({}, r), { namespaces: a })),
          this.onSessionUpdate(),
          this.events.emit("session_update", { topic: t, params: e });
      }),
      this.client.on("session_delete", async (t) => {
        var e;
        t.topic === ((e = this.session) == null ? void 0 : e.topic) &&
          (await this.cleanup(),
          this.events.emit("session_delete", t),
          this.events.emit(
            "disconnect",
            T(M({}, st("USER_DISCONNECTED")), { data: t.topic })
          ));
      }),
  ...
  setNamespaces(t) {
    ...
    (this.optionalNamespaces = L(e, i)),
      (this.sessionProperties = n),
      (this.scopedProperties = a);
  }
  validateChain(t) {
    const [e, i] = t?.split(":") || ["", ""];
    ...
    if (e && i) return [e, i];
    const n = _(Object.keys(this.namespaces)[0]),
  ...
  async onChainChanged(t, e = !1) {
    ...
    e
      ...
      : this.getProvider(i).setDefaultChain(n),
      await this.persist("namespaces", this.namespaces);
  }
  emitAccountsChangedOnChainChange({
    ...
    try {
      if (e === i) return;
      const r =
        (a = (n = this.session) == null ? void 0 : n.namespaces[t]) == null
          ? void 0
          : a.accounts;
      if (!r) return;
  ...
  updateNamespaceChain(t, e) {
    if (!this.namespaces) return;
    const i = this.namespaces[t] ? t : `${t}:${e}`,
      n = { chains: [], methods: [], events: [], defaultChain: e };
    this.namespaces[i]
      ? this.namespaces[i] && (this.namespaces[i].defaultChain = e)
      : (this.namespaces[i] = n);
  }
  onConnect() {
  ...
  async cleanupStorage() {
    ...
    try {
      ...
      for (const i of e)
        i.startsWith(F) && (await this.client.core.storage.removeItem(i));
    } catch (e) {
...
const vs = B;
export { vs as UniversalProvider, B as default };
