import {
  RELAYER_EVENTS as ze,
  TRANSPORT_TYPES as q,
  EXPIRER_EVENTS as Nt,
  PAIRING_EVENTS as Ye,
  RELAYER_DEFAULT_PROTOCOL as Ot,
  EVENT_CLIENT_SESSION_TRACES as K,
  EVENT_CLIENT_SESSION_ERRORS as ne,
  EVENT_CLIENT_AUTHENTICATE_TRACES as z,
  EVENT_CLIENT_AUTHENTICATE_ERRORS as oe,
  EVENT_CLIENT_PAIRING_ERRORS as bt,
  EVENT_CLIENT_PAIRING_TRACES as At,
  VERIFY_SERVER as xt,
  Store as W,
  Core as Vt,
...
import {
  pino as Ct,
  getDefaultLoggerOptions as kt,
  generateChildLogger as Dt,
  getLoggerContext as Lt,
} from "@walletconnect/logger";
import { IEngine as Mt, ISignClient as $t } from "@walletconnect/types";
import {
  LimitedSet as Kt,
  getInternalError as g,
  BASE64URL as ae,
  BASE64 as Y,
  hashMessage as U,
  parseExpirerTarget as Ut,
  isValidString as J,
  isExpired as Z,
  isValidId as Gt,
  mergeRequiredAndOptionalNamespaces as jt,
  calcExpiry as x,
  engineEvent as v,
  createDelayedPromise as ee,
  getSdkError as D,
  getDeepLink as Ft,
  handleDeeplinkRedirect as Qt,
  isSessionCompatible as Ht,
  hashKey as Oe,
  parseChainId as be,
  createEncodedRecap as zt,
  getRecapFromResources as Ae,
  mergeEncodedRecaps as Yt,
  TYPE_2 as Jt,
  getLinkModeURL as ge,
  validateSignedCacao as Je,
  getNamespacedDidChainId as Xe,
  getDidAddress as Be,
  getMethodsFromRecap as We,
  getChainsFromRecap as Ze,
  buildNamespacesFromAuth as et,
  formatMessage as Xt,
  MemoryStore as ce,
  isValidParams as L,
  isUndefined as X,
  isValidRelays as Bt,
  isValidObject as tt,
  isValidRequiredNamespaces as Wt,
  isValidNamespaces as xe,
  isConformingNamespaces as st,
  isValidErrorReason as Zt,
  isValidRelay as es,
  isValidController as ts,
  isValidNamespacesChainId as it,
  isValidRequest as ss,
  isValidNamespacesRequest as is,
  isValidRequestExpiry as rs,
  isValidResponse as ns,
  isValidEvent as os,
  isValidNamespacesEvent as as,
  getSearchParamFromURL as rt,
  isTestRun as cs,
  isReactNative as ls,
  getSuiDigest as ps,
  getNearTransactionIdFromSignedTransaction as nt,
  buildSignedExtrinsicHash as hs,
  isValidArray as ot,
  getAlgorandTransactionId as at,
  getSignDirectHash as ds,
  extractSolanaTransactionId as us,
  TYPE_1 as Ve,
  populateAppMetadata as gs,
} from "@walletconnect/utils";
import ys, { EventEmitter as ws } from "events";
import {
  THIRTY_DAYS as ms,
  SEVEN_DAYS as ct,
  FIVE_MINUTES as V,
...
import {
  isJsonRpcRequest as fs,
  isJsonRpcResponse as Es,
  payloadId as j,
  getBigIntRpcId as ye,
  isJsonRpcResult as F,
  isJsonRpcError as Q,
  formatJsonRpcRequest as te,
  formatJsonRpcResult as ht,
  formatJsonRpcError as Ss,
...
const Ce = "wc",
  ...
  P = {
    wc_sessionPropose: {
      req: { ttl: V, prompt: !0, tag: 1100 },
      res: { ttl: V, prompt: !1, tag: 1101 },
      reject: { ttl: V, prompt: !1, tag: 1120 },
      autoReject: { ttl: V, prompt: !1, tag: 1121 },
    },
    wc_sessionSettle: {
      req: { ttl: V, prompt: !1, tag: 1102 },
      res: { ttl: V, prompt: !1, tag: 1103 },
    },
    wc_sessionUpdate: {
      req: { ttl: G, prompt: !1, tag: 1104 },
      res: { ttl: G, prompt: !1, tag: 1105 },
    },
    wc_sessionExtend: {
      req: { ttl: G, prompt: !1, tag: 1106 },
      res: { ttl: G, prompt: !1, tag: 1107 },
    },
    wc_sessionRequest: {
      req: { ttl: V, prompt: !0, tag: 1108 },
      res: { ttl: V, prompt: !1, tag: 1109 },
    },
    wc_sessionEvent: {
      req: { ttl: V, prompt: !0, tag: 1110 },
      res: { ttl: V, prompt: !1, tag: 1111 },
    },
    wc_sessionDelete: {
      req: { ttl: G, prompt: !1, tag: 1112 },
      res: { ttl: G, prompt: !1, tag: 1113 },
    },
    wc_sessionPing: {
      req: { ttl: G, prompt: !1, tag: 1114 },
      res: { ttl: G, prompt: !1, tag: 1115 },
    },
    wc_sessionAuthenticate: {
      req: { ttl: lt, prompt: !0, tag: 1116 },
      res: { ttl: lt, prompt: !1, tag: 1117 },
      reject: { ttl: V, prompt: !1, tag: 1118 },
      autoReject: { ttl: V, prompt: !1, tag: 1119 },
    },
  },
  _e = { min: V, max: ct },
  M = { idle: "IDLE", active: "ACTIVE" },
  yt = {
...
var Os = Object.defineProperty,
  ...
  $e = (E, o, t) =>
    o in E
      ? Os(E, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (E[o] = t),
  R = (E, o) => {
  ...
  O = (E, o) => bs(E, As(o)),
  c = (E, o, t) => $e(E, typeof o != "symbol" ? o + "" : o, t);
class Cs extends Mt {
  constructor(o) {
    super(o),
      c(this, "name", gt),
      c(this, "events", new ys()),
      c(this, "initialized", !1),
      c(this, "requestQueue", { state: M.idle, queue: [] }),
      c(this, "sessionRequestQueue", { state: M.idle, queue: [] }),
      c(this, "emittedSessionRequests", new Kt({ limit: 500 })),
      c(this, "requestQueueDelay", _s),
      ...
      c(this, "init", async () => {
        this.initialized ||
          ...
          this.client.core.pairing.register({ methods: Object.keys(P) }),
          (this.initialized = !0),
          setTimeout(async () => {
      ...
      c(this, "connect", async (t) => {
        ...
        await this.isValidConnect(e),
          (e.optionalNamespaces = jt(
            e.requiredNamespaces,
            e.optionalNamespaces
          )),
          (e.requiredNamespaces = {});
        const {
          pairingTopic: s,
        ...
        const d = await this.client.core.crypto.generateKeyPair(),
          y = P.wc_sessionPropose.req.ttl || V,
          w = x(y),
          m = O(
            R(
              R(
          ...
          S = v("session_connect", m.id),
          { reject: _, resolve: b, done: C } = ee(y, Me),
          I = ({ id: T }) => {
            T === m.id &&
              (this.client.events.off("proposal_expire", I),
              this.pendingSessions.delete(m.id),
              this.events.emit(S, { error: { message: Me, code: 0 } }));
          };
        return (
          this.client.events.on("proposal_expire", I),
          this.events.once(S, ({ error: T, session: $ }) => {
      ...
      c(this, "approve", async (t) => {
        ...
        try {
          ...
          throw (r.setError(ne.no_internet_connection), N);
        }
        try {
          ...
          throw (
            (this.client.logger.error(
              `approve() -> proposal.get(${t?.id}) failed`
            ),
            r.setError(ne.proposal_not_found),
            N)
          );
        }
        try {
          ...
          throw (
            ...
            r.setError(ne.session_approve_namespace_validation_failure),
            N)
          );
        }
        const {
            ...
            (i = this.client.core.eventClient) == null
              ...
              : i.createEvent({
                  ...
                  properties: {
                    topic: y,
                    trace: [
                      K.session_approve_started,
                      K.session_namespaces_validation_success,
                    ],
                  },
                }));
        const b = await this.client.core.crypto.generateKeyPair(),
          C = w.publicKey,
          I = await this.client.core.crypto.generateSharedKey(b, C),
          T = R(
            R(
              R(
                {
                  ...
                  namespaces: l,
                  controller: { publicKey: b, metadata: this.client.metadata },
                  expiry: x(B),
                },
          ...
          $ = q.relay;
        _.addTrace(K.subscribing_session_topic);
        try {
          ...
          throw (_.setError(ne.subscribe_session_topic_failure), N);
        }
        _.addTrace(K.subscribe_session_topic_success);
        const Ee = O(R({}, T), {
          topic: I,
          requiredNamespaces: m,
          optionalNamespaces: S,
        ...
        await this.client.session.set(I, Ee), _.addTrace(K.store_session);
        try {
          await this.sendApproveSession({
            ...
            _.addTrace(K.session_approve_publish_success);
        } catch (N) {
          throw (
            (this.client.logger.error(N),
            this.client.session.delete(I, D("USER_DISCONNECTED")),
      ...
      c(this, "update", async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error("update() -> isValidUpdate() failed"), h)
          );
        }
        const { topic: e, namespaces: s } = t,
          { done: i, resolve: r, reject: n } = ee(),
          a = j(),
          l = ye().toString(),
          p = this.client.session.get(e).namespaces;
        return (
          this.events.once(v("session_update", a), ({ error: h }) => {
            h ? n(h) : r();
          }),
          ...
          await this.sendRequest({
            ...
            this.client.logger.error(h),
              this.client.session.update(e, { namespaces: p }),
              n(h);
          }),
          { acknowledged: i }
        );
      ...
      c(this, "extend", async (t) => {
        ...
        const { topic: e } = t,
          ...
          { done: i, resolve: r, reject: n } = ee();
        return (
          this.events.once(v("session_extend", s), ({ error: a }) => {
            a ? n(a) : r();
          }),
          await this.setExpiry(e, x(B)),
          this.sendRequest({
            topic: e,
      ...
      c(this, "request", async (t) => {
        ...
        const {
            ...
            request: s,
            topic: i,
            expiry: r = P.wc_sessionRequest.req.ttl,
          } = t,
          n = this.client.session.get(i);
        n?.transportType === q.relay &&
        ...
        this.events.once(v("session_request", a), ({ error: m, result: S }) => {
          m ? u(m) : h(S);
        });
        const d = "wc_sessionRequest",
          y = this.getAppLinkIfEnabled(n.peer.metadata, n.transportType);
        if (y)
          return (
            await this.sendRequest({
              clientRpcId: a,
              ...
              method: d,
              params: {
                request: O(R({}, s), { expiryTimestamp: x(r) }),
                chainId: e,
              },
              expiry: r,
              throwOnFailedPublish: !0,
        ...
        return await Promise.all([
          ...
          new Promise(async (m) => {
            ...
            if (!((S = n.sessionConfig) != null && S.disableDeepLink)) {
              const _ = await Ft(this.client.core.storage, Le);
              await Qt({ id: a, topic: i, wcDeepLink: _ });
            }
            m();
          }),
          p(),
      ...
      c(this, "ping", async (t) => {
        ...
        if (this.client.session.keys.includes(e)) {
          const s = j(),
            i = ye().toString(),
            { done: r, resolve: n, reject: a } = ee();
          this.events.once(v("session_ping", s), ({ error: l }) => {
            l ? a(l) : n();
          }),
            await Promise.all([
              this.sendRequest({
      ...
      c(
        ...
        (t) => (
          this.isInitialized(),
          this.client.session.getAll().filter((e) => Ht(e, t))
        )
      ),
      c(this, "getPendingSessionRequests", () =>
        this.client.pendingRequest.getAll()
      ),
      c(this, "authenticate", async (t, e) => {
        var s;
        this.isInitialized(), this.isValidAuthenticate(t);
        const i =
            e &&
            this.client.core.linkModeSupportedApps.includes(e) &&
            ((s = this.client.metadata.redirect) == null ? void 0 : s.linkMode),
          r = i ? q.link_mode : q.relay;
        ...
        if (
          ...
          await this.client.core.relayer.subscribe(I, { transportType: r }),
          this.client.logger.info(`sending request to new pairing topic: ${_}`),
          w.length > 0)
        ) {
          const { namespace: A } = be(n[0]);
          let k = zt(A, "request", w);
          Ae(S) && (k = Yt(k, S.pop())), S.push(k);
        }
        const T =
            m && m > P.wc_sessionAuthenticate.req.ttl
              ? m
              : P.wc_sessionAuthenticate.req.ttl,
          $ = {
            authPayload: {
              type: u ?? "caip122",
              chains: n,
          ...
          N = {
            ...
            expiryTimestamp: x(P.wc_sessionPropose.req.ttl),
            id: j(),
          },
          { done: Tt, resolve: Ue, reject: Se } = ee(T, "Request expired"),
          se = j(),
          he = v("session_connect", N.id),
          Re = v("session_request", se),
          de = async ({ error: A, session: k }) => {
            this.events.off(Re, ve), A ? Se(A) : k && Ue({ session: k });
          },
          ve = async (A) => {
            var k, Ge, je;
            if (
              (await this.deletePendingAuthRequest(se, {
                message: "fulfilled",
                code: 0,
              }),
              A.error)
            ) {
              const re = D("WC_METHOD_UNSUPPORTED", "wc_sessionAuthenticate");
              return A.error.code === re.code
                ? void 0
                : (this.events.off(he, de), Se(A.error.message));
            }
            await this.deleteProposal(N.id), this.events.off(he, de);
            const { cacaos: Fe, responder: H } = A.result,
              Te = [],
              Qe = [];
            for (const re of Fe) {
              (await Je({
                ...
                (this.client.logger.error(re, "Signature verification failed"),
                Se(
                  D(
            ...
            const ie = await this.client.core.crypto.generateSharedKey(
              C,
              H.publicKey
            );
            let ue;
            Te.length > 0 &&
              ((ue = {
                ...
                relay: { protocol: "irn" },
                pairingTopic: _,
                namespaces: et([...new Set(Te)], [...new Set(Qe)]),
                transportType: r,
              }),
              await this.client.core.relayer.subscribe(ie, {
                transportType: r,
              }),
              await this.client.session.set(ie, ue),
              _ &&
                (await this.client.core.pairing.updateMetadata({
                  topic: _,
                  metadata: H.metadata,
                })),
              (ue = this.client.session.get(ie))),
              (k = this.client.metadata.redirect) != null &&
                k.linkMode &&
                (Ge = H.metadata.redirect) != null &&
                Ge.linkMode &&
                (je = H.metadata.redirect) != null &&
                je.universal &&
                e &&
                (this.client.core.addLinkModeSupportedApp(
                  H.metadata.redirect.universal
                ),
                this.client.session.update(ie, { transportType: q.link_mode })),
              Ue({ auths: Fe, session: ue });
          };
        this.events.once(he, de), this.events.once(Re, ve);
        let Ie;
        try {
          if (i) {
            const A = te("wc_sessionAuthenticate", $, se);
        ...
        return (
          await this.setProposal(N.id, N),
          await this.setAuthRequest(se, {
            request: O(R({}, $), { verifyContext: {} }),
            pairingTopic: _,
            transportType: r,
          }),
          { uri: Ie ?? b, response: Tt }
        );
      }),
      c(this, "approveSessionAuthenticate", async (t) => {
        ...
        try {
          ...
          throw (i.setError(oe.no_internet_connection), m);
        }
        const r = this.getPendingAuthRequest(e);
        if (!r)
          throw (
            (i.setError(oe.authenticated_session_pending_request_not_found),
            new Error(`Could not find pending auth request with id ${e}`))
          );
        ...
        const a = r.requester.publicKey,
          ...
          p = Oe(a),
          h = { type: Ve, receiverPublicKey: a, senderPublicKey: l },
          u = [],
          d = [];
        for (const m of s) {
          if (
            !(await Je({ cacao: m, projectId: this.client.core.projectId }))
          ) {
            i.setError(oe.invalid_cacao);
            const I = D(
              "SESSION_SETTLEMENT_FAILED",
              "Signature verification failed"
            );
        ...
        if (u?.length > 0) {
          (w = {
            ...
            namespaces: et([...new Set(u)], [...new Set(d)]),
            transportType: n,
          }),
          ...
          try {
            ...
            throw (
              (i.setError(oe.subscribe_authenticated_session_topic_failure), m)
            );
          }
          i.addTrace(z.subscribe_authenticated_session_topic_success),
            await this.client.session.set(y, w),
            i.addTrace(z.store_authenticated_session),
            await this.client.core.pairing.updateMetadata({
        ...
        try {
          ...
          throw (
            (i.setError(oe.authenticated_session_approve_publish_failure), m)
          );
        }
        return (
      ...
      c(this, "rejectSessionAuthenticate", async (t) => {
        ...
        const r = i.requester.publicKey,
          ...
          a = Oe(r),
          l = { type: Ve, receiverPublicKey: r, senderPublicKey: n };
        await this.sendError({
          id: e,
          topic: a,
          error: s,
      ...
      c(this, "deleteSession", async (t) => {
        ...
        await this.client.core.relayer.unsubscribe(s),
          await this.client.session.delete(s, D("USER_DISCONNECTED")),
          ...
          this.getPendingSessionRequests().forEach((l) => {
            l.topic === s &&
              this.deletePendingSessionRequest(l.id, D("USER_DISCONNECTED"));
          }),
          s ===
            ((e = this.sessionRequestQueue.queue[0]) == null
              ? void 0
              : e.topic) && (this.sessionRequestQueue.state = M.idle),
      ...
      c(this, "deleteProposal", async (t, e) => {
        ...
        await Promise.all([
          this.client.proposal.delete(t, D("USER_DISCONNECTED")),
      ...
      c(this, "deletePendingSessionRequest", async (t, e, s = !1) => {
        await Promise.all([
          ...
          s &&
            ((this.sessionRequestQueue.state = M.idle),
      ...
      c(this, "setProposal", async (t, e) => {
        this.client.core.expirer.set(t, x(P.wc_sessionPropose.req.ttl)),
      ...
      c(this, "setPendingSessionRequest", async (t) => {
        const { id: e, topic: s, params: i, verifyContext: r } = t,
          n = i.request.expiryTimestamp || x(P.wc_sessionRequest.req.ttl);
      ...
      c(this, "sendRequest", async (t) => {
        ...
        let m;
        if (mt.includes(s)) {
          const _ = U(JSON.stringify(d)),
            b = U(y);
          m = await this.client.core.verify.register({ id: b, decryptedId: _ });
        }
        ...
        if (
          ...
          r && (S.ttl = r),
          n && (S.id = n),
          this.client.core.history.set(e, d),
          w)
        ) {
          const _ = ge(p, e, y);
          await global.Linking.openURL(_, this.client.name);
        } else
          (S.tvf = O(R({}, h), { correlationId: d.id })),
            l
              ? ((S.internal = O(R({}, S.internal), {
                  throwOnFailedPublish: !0,
                })),
                await this.client.core.relayer.publish(e, y, S))
      ...
      c(this, "sendProposeSession", async (t) => {
        const { proposal: e, publishOpts: s } = t,
          i = te("wc_sessionPropose", e, e.id);
        this.client.core.history.set(e.pairingTopic, i);
        const r = await this.client.core.crypto.encode(e.pairingTopic, i, {
            encoding: Y,
          }),
          n = U(JSON.stringify(i)),
          a = U(r),
          l = await this.client.core.verify.register({ id: a, decryptedId: n });
        await this.client.core.relayer.publishCustom({
          payload: { pairingTopic: e.pairingTopic, sessionProposal: r },
          opts: O(R({}, s), {
      ...
      c(this, "sendApproveSession", async (t) => {
        const {
            sessionTopic: e,
            pairingProposalResponse: s,
            proposal: i,
            sessionSettleRequest: r,
            publishOpts: n,
          } = t,
          a = ht(i.id, s),
          l = await this.client.core.crypto.encode(i.pairingTopic, a, {
            encoding: Y,
          }),
          p = te("wc_sessionSettle", r, n?.id),
          h = await this.client.core.crypto.encode(e, p, { encoding: Y });
        this.client.core.history.set(e, p),
          await this.client.core.relayer.publishCustom({
            payload: {
              sessionTopic: e,
      ...
      c(this, "sendResult", async (t) => {
        ...
        try {
          ...
          try {
            ...
            this.client.logger.warn(
              `sendResult() -> getTVFParams() failed: ${w?.message}`
            );
          }
        } catch (y) {
          throw (
        ...
        if (h) {
          ...
          const y = u.request.method,
            w = P[y].res;
          (w.tvf = O(R({}, d), { correlationId: e })),
            r
              ? ((w.internal = O(R({}, w.internal), {
                  throwOnFailedPublish: !0,
                })),
                await this.client.core.relayer.publish(s, p, w))
              : this.client.core.relayer
                  .publish(s, p, w)
                  .catch((m) => this.client.logger.error(m));
        }
      ...
      c(this, "cleanup", async () => {
        ...
        this.client.session.getAll().forEach((s) => {
          ...
          this.client.proposal.getAll().forEach((s) => {
            Z(s.expiryTimestamp) && e.push(s.id);
          }),
          await Promise.all([
      ...
      c(this, "processRequest", async (t) => {
        const {
          ...
          a = s.method;
        if (!this.shouldIgnorePairingRequest({ topic: e, requestMethod: a }))
          switch (a) {
      ...
      c(this, "onRelayEventResponse", async (t) => {
        const { topic: e, payload: s, transportType: i } = t,
          r = (await this.client.core.history.get(e, s.id)).request.method;
        switch (r) {
          case "wc_sessionPropose":
      ...
      c(this, "onSessionProposeRequest", async (t) => {
        ...
        try {
          ...
          this.client.events.listenerCount("session_proposal") === 0 &&
            ...
            l?.setError(bt.proposal_listener_not_found)),
            this.isValidConnect(R({}, s.params));
          const p = n.expiryTimestamp || x(P.wc_sessionPropose.req.ttl),
            h = R(
              {
                id: a,
                pairingTopic: e,
          ...
          const u = await this.getVerifyContext({
            attestationId: i,
            hash: U(JSON.stringify(s)),
            encryptedId: r,
            metadata: h.proposer.metadata,
          });
          l?.addTrace(At.emit_session_proposal),
      ...
      c(this, "onSessionSettleRequest", async (t, e) => {
        ...
        try {
          ...
          const y = this.client.proposal.get(d.proposalId),
            w = O(
              R(
                R(
                  R(
          ...
          await this.client.session.set(w.topic, w),
            ...
            this.events.emit(v("session_connect", d.proposalId), {
              session: w,
            }),
      ...
      c(this, "onSessionSettleResponse", async (t, e) => {
        ...
        F(e)
          ? (await this.client.session.update(t, { acknowledged: !0 }),
            this.events.emit(v("session_approve", s), {}))
          : Q(e) &&
            (await this.client.session.delete(t, D("USER_DISCONNECTED")),
            this.events.emit(v("session_approve", s), { error: e.error }));
      }),
          ...
          if (n && this.isRequestOutOfSync(n, i)) {
            this.client.logger.warn(`Discarding out of sync request - ${i}`),
              this.sendError({
                id: i,
                topic: t,
                error: D("INVALID_UPDATE_REQUEST"),
              });
            return;
          }
      ...
      c(
        this,
        "isRequestOutOfSync",
        (t, e) => e.toString().slice(0, -3) < t.toString().slice(0, -3)
      ),
      c(this, "onSessionUpdateResponse", (t, e) => {
        const { id: s } = e,
          i = v("session_update", s);
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        F(e)
          ? this.events.emit(v("session_update", s), {})
          : Q(e) &&
            this.events.emit(v("session_update", s), { error: e.error });
      }),
      c(this, "onSessionExtendRequest", async (t, e) => {
        const { id: s } = e;
        try {
          this.isValidExtend({ topic: t }),
            await this.setExpiry(t, x(B)),
            await this.sendResult({ id: s, topic: t, result: !0 }),
      ...
      c(this, "onSessionExtendResponse", (t, e) => {
        const { id: s } = e,
          i = v("session_extend", s);
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        F(e)
          ? this.events.emit(v("session_extend", s), {})
          : Q(e) &&
            this.events.emit(v("session_extend", s), { error: e.error });
      }),
      ...
      c(this, "onSessionPingResponse", (t, e) => {
        ...
        setTimeout(() => {
          ...
          F(e)
            ? this.events.emit(v("session_ping", s), {})
            : Q(e) &&
              this.events.emit(v("session_ping", s), { error: e.error });
        }, 500);
      }),
      c(this, "onSessionDeleteRequest", async (t, e) => {
        ...
        try {
          this.isValidDisconnect({ topic: t, reason: e.params }),
            await Promise.all([
              new Promise((i) => {
                this.client.core.relayer.once(ze.publish, async () => {
                  i(await this.deleteSession({ topic: t, id: s }));
                });
              }),
              this.sendResult({ id: s, topic: t, result: !0 }),
              this.cleanupPendingSentRequestsForTopic({
                topic: t,
                error: D("USER_DISCONNECTED"),
              }),
        ...
        try {
          ...
          const d = this.client.session.get(r),
            y = await this.getVerifyContext({
              attestationId: a,
              hash: U(JSON.stringify(te("wc_sessionRequest", u, h))),
              encryptedId: l,
              metadata: d.peer.metadata,
              transportType: p,
            }),
            w = { id: h, topic: r, params: u, verifyContext: y };
          await this.setPendingSessionRequest(w),
            p === q.link_mode &&
              (e = d.peer.metadata.redirect) != null &&
              e.universal &&
              this.client.core.addLinkModeSupportedApp(
                (s = d.peer.metadata.redirect) == null ? void 0 : s.universal
              ),
          ...
          await this.sendError({ id: h, topic: r, error: d }),
            this.client.logger.error(d);
        }
      }),
      c(this, "onSessionRequestResponse", (t, e) => {
        const { id: s } = e,
          i = v("session_request", s);
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        F(e)
          ? this.events.emit(v("session_request", s), { result: e.result })
          : Q(e) &&
            this.events.emit(v("session_request", s), { error: e.error });
      }),
      ...
      c(this, "onSessionAuthenticateRequest", async (t) => {
        ...
        try {
          const { requester: l, authPayload: p, expiryTimestamp: h } = i.params,
            u = await this.getVerifyContext({
              attestationId: r,
              hash: U(JSON.stringify(i)),
              encryptedId: n,
              metadata: l.metadata,
              transportType: a,
            }),
          ...
          const p = i.params.requester.publicKey,
            ...
            d = { type: Ve, receiverPublicKey: p, senderPublicKey: h };
          await this.sendError({
            id: i.id,
            topic: s,
            error: l,
      ...
      c(this, "emitSessionRequest", (t) => {
        ...
        (this.sessionRequestQueue.state = M.active),
      ...
      c(this, "isValidConnect", async (t) => {
        ...
        if ((X(e) || (await this.isValidPairingTopic(e)), !Bt(a, !0))) {
          const { message: l } = g(
            "MISSING_OR_INVALID",
            `connect() relays: ${a}`
          );
        ...
        if (
          ...
          if (!Object.keys(n).every((p) => l.includes(p.split(":")[0])))
            throw new Error(
      ...
      c(this, "validateNamespaces", (t, e) => {
        const s = Wt(t, "connect()", e);
        if (s) throw new Error(s.message);
      }),
      c(this, "isValidApprove", async (t) => {
        if (!L(t))
          throw new Error(
            g("MISSING_OR_INVALID", `approve() params: ${t}`).message
          );
        const {
          id: e,
          namespaces: s,
        ...
        const p = st(a.requiredNamespaces, s, "approve()");
        ...
        if (
          (X(r) || this.validateSessionProps(r, "sessionProperties"), !X(n))
        ) {
          this.validateSessionProps(n, "scopedProperties");
          const h = new Set(Object.keys(s));
          if (!Object.keys(n).every((u) => h.has(u.split(":")[0])))
            throw new Error(
      ...
      c(this, "isValidSessionSettleRequest", (t) => {
        ...
        const n = ts(s, "onSessionSettleRequest()");
      ...
      c(this, "isValidUpdate", async (t) => {
        ...
        const n = st(i.requiredNamespaces, s, "update()");
        if (n) throw new Error(n.message);
      }),
      ...
      c(this, "isValidRequest", async (t) => {
        ...
        if (r && !rs(r, _e)) {
          const { message: a } = g(
            "MISSING_OR_INVALID",
            `request() expiry: ${r}. Expiry must be a number (in seconds) between ${_e.min} and ${_e.max}`
          );
          throw new Error(a);
        }
      }),
      ...
      c(this, "isValidPing", async (t) => {
        if (!L(t)) {
          const { message: s } = g("MISSING_OR_INVALID", `ping() params: ${t}`);
          throw new Error(s);
        }
        const { topic: e } = t;
      ...
      c(this, "isValidEmit", async (t) => {
        if (!L(t)) {
          const { message: n } = g("MISSING_OR_INVALID", `emit() params: ${t}`);
          throw new Error(n);
        }
        const { topic: e, event: s, chainId: i } = t;
      ...
      c(this, "isValidAuthenticate", (t) => {
        ...
        if (!J(s, !1)) throw new Error("uri is required parameter");
        if (!J(i, !1)) throw new Error("domain is required parameter");
        if (!J(r, !1)) throw new Error("nonce is required parameter");
        if ([...new Set(e.map((a) => be(a).namespace))].length > 1)
          throw new Error(
            "Multi-namespace requests are not supported. Please request single namespace only."
          );
        const { namespace: n } = be(e[0]);
        if (n !== "eip155")
          throw new Error(
      ...
      c(this, "getVerifyContext", async (t) => {
        ...
        try {
          if (n === q.link_mode) {
            ...
            return (
              (a.verified.validation =
                p && new URL(p).origin === new URL(r.url).origin
                  ? "VALID"
                  : "INVALID"),
              a
            );
          ...
          l &&
            ...
            (a.verified.validation =
              l.origin === new URL(r.url).origin ? "VALID" : "INVALID"));
        } catch (l) {
          this.client.logger.warn(l);
        }
        return (
      ...
      c(this, "validateSessionProps", (t, e) => {
        Object.values(t).forEach((s, i) => {
          if (s == null) {
            const { message: r } = g(
              "MISSING_OR_INVALID",
              `${e} must contain an existing value for each key. Received: ${s} for key ${
                Object.keys(t)[i]
              }`
            );
            throw new Error(r);
          ...
          : ((i = (s = this.client.metadata) == null ? void 0 : s.redirect) ==
            null
              ...
              null
                ? void 0
                : n.universal) !== void 0 &&
              ((l = (a = this.client.metadata) == null ? void 0 : a.redirect) ==
              null
                ? void 0
                : l.universal) !== "" &&
              ((p = t?.redirect) == null ? void 0 : p.universal) !== void 0 &&
              ((h = t?.redirect) == null ? void 0 : h.universal) !== "" &&
              ((u = t?.redirect) == null ? void 0 : u.linkMode) === !0 &&
      ...
      c(this, "getAppLinkIfEnabled", (t, e) => {
        var s;
        return this.isLinkModeEnabled(t, e)
          ? (s = t?.redirect) == null
            ? void 0
            : s.universal
          : void 0;
      ...
      c(this, "handleLinkModeMessage", ({ url: t }) => {
        ...
        const e = rt(t, "topic") || "",
          s = decodeURIComponent(rt(t, "wc_ev") || ""),
          i = this.client.session.keys.includes(e);
        i && this.client.session.update(e, { transportType: q.link_mode }),
      ...
      c(this, "registerLinkModeListeners", async () => {
        ...
        if (
          cs() ||
          (ls() && (t = this.client.metadata.redirect) != null && t.linkMode)
        ) {
      ...
      c(this, "getTVFParams", (t, e, s) => {
        ...
        try {
          ...
          (a.txHashes = l),
            (a.contractAddresses = this.isValidContractData(e.request.params)
              ? [
                  (n = (r = e.request.params) == null ? void 0 : r[0]) == null
                    ? void 0
                    : n.to,
                ]
              : []);
      ...
      c(this, "extractTxHashesFromResult", (t, e) => {
        ...
        try {
          ...
          const i = t.method,
            r = yt[i];
          if (i === "sui_signTransaction") return [ps(e.transactionBytes)];
          if (i === "near_signTransaction") return [nt(e)];
          if (i === "near_signTransactions") return e.map((a) => nt(a));
          ...
          if (i === "algo_signTxn")
            return ot(e) ? e.map((a) => at(a)) : [at(e)];
          if (i === "cosmos_signDirect") return [ds(e)];
          if (typeof e == "string") return [e];
          const n = e[r.key];
          if (ot(n))
            return i === "solana_signAllTransactions" ? n.map((a) => us(a)) : n;
  ...
  async processPendingMessageEvents() {
    try {
      const o = this.client.session.keys,
        t = this.client.core.relayer.messages.getWithoutAck(o);
      for (const [e, s] of Object.entries(t))
        for (const i of s)
          try {
            ...
            this.client.logger.warn(
              `Error processing pending message event for topic: ${e}, message: ${i}`
            );
          }
    } catch (o) {
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: o } = g("NOT_INITIALIZED", this.name);
      throw new Error(o);
    }
  }
  ...
  registerRelayerEvents() {
    this.client.core.relayer.on(ze.message, (o) => {
      this.onProviderMessageEvent(o);
    });
  }
  async onRelayMessage(o) {
    const { topic: t, message: e, attestation: s, transportType: i } = o,
      { publicKey: r } = this.client.auth.authKeys.keys.includes(pe)
        ? this.client.auth.authKeys.get(pe)
        : { responseTopic: void 0, publicKey: void 0 };
    try {
      const n = await this.client.core.crypto.decode(t, e, {
        receiverPublicKey: r,
        encoding: i === q.link_mode ? ae : Y,
      });
      fs(n)
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(Nt.expired, async (o) => {
      const { topic: t, id: e } = Ut(o.target);
      if (e && this.client.pendingRequest.keys.includes(e))
        return await this.deletePendingSessionRequest(e, g("EXPIRED"), !0);
      if (e && this.client.auth.requests.keys.includes(e))
        return await this.deletePendingAuthRequest(e, g("EXPIRED"), !0);
      t
        ? this.client.session.keys.includes(t) &&
  ...
  registerPairingEvents() {
    this.client.core.pairing.events.on(Ye.create, (o) =>
      this.onPairingCreated(o)
    ),
      this.client.core.pairing.events.on(Ye.delete, (o) => {
  ...
  isValidPairingTopic(o) {
    ...
    if (Z(this.client.core.pairing.pairings.get(o).expiry)) {
      const { message: t } = g("EXPIRED", `pairing topic: ${o}`);
      throw new Error(t);
    }
  }
  async isValidSessionTopic(o) {
    ...
    if (Z(this.client.session.get(o).expiry)) {
      await this.deleteSession({ topic: o });
      const { message: t } = g("EXPIRED", `session topic: ${o}`);
      throw new Error(t);
    }
  ...
  async isValidProposalId(o) {
    ...
    if (Z(this.client.proposal.get(o).expiryTimestamp)) {
      await this.deleteProposal(o);
      const { message: t } = g("EXPIRED", `proposal id: ${o}`);
      throw new Error(t);
    }
  }
}
...
var Ks = Object.defineProperty,
  Us = (E, o, t) =>
    o in E
      ? Ks(E, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (E[o] = t),
  Ke = (E, o, t) => Us(E, typeof o != "symbol" ? o + "" : o, t);
class Gs {
  constructor(o, t) {
    (this.core = o),
      (this.logger = t),
...
var js = Object.defineProperty,
  Fs = (E, o, t) =>
    o in E
      ? js(E, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (E[o] = t),
  f = (E, o, t) => Fs(E, typeof o != "symbol" ? o + "" : o, t);
class fe extends $t {
  constructor(o) {
    super(o),
      f(this, "protocol", Ce),
      ...
      f(this, "auth"),
      f(this, "signConfig"),
      f(this, "on", (e, s) => this.events.on(e, s)),
      f(this, "once", (e, s) => this.events.once(e, s)),
      f(this, "off", (e, s) => this.events.off(e, s)),
      f(this, "removeListener", (e, s) => this.events.removeListener(e, s)),
      f(this, "removeAllListeners", (e) => this.events.removeAllListeners(e)),
      f(this, "connect", async (e) => {
        try {
      ...
      (this.name = o?.name || me.name),
      (this.metadata = gs(o?.metadata)),
      (this.signConfig = o?.signConfig);
    const t =
      typeof o?.logger < "u" && typeof o?.logger != "string"
        ? o.logger
        : Ct(kt({ level: o?.logger || me.logger }));
    (this.core = o?.core || new Vt(o)),
      (this.logger = Dt(t, this.name)),
      (this.session = new It(this.core, this.logger)),
...
export {
  ft as AUTH_CONTEXT,
  Et as AUTH_KEYS_CONTEXT,
  St as AUTH_PAIRING_TOPIC_CONTEXT,
  _t as AUTH_PROTOCOL,
  pe as AUTH_PUBLIC_KEY_NAME,
  Rt as AUTH_REQUEST_CONTEXT,
  le as AUTH_STORAGE_PREFIX,
  Ns as AUTH_VERSION,
  gt as ENGINE_CONTEXT,
  M as ENGINE_QUEUE_STATES,
  P as ENGINE_RPC_OPTS,
  Ts as HISTORY_CONTEXT,
  Is as HISTORY_EVENTS,
  qs as HISTORY_STORAGE_VERSION,
  mt as METHODS_TO_VERIFY,
  dt as PROPOSAL_CONTEXT,
  Ps as PROPOSAL_EXPIRY,
  Me as PROPOSAL_EXPIRY_MESSAGE,
  wt as REQUEST_CONTEXT,
  ut as SESSION_CONTEXT,
  B as SESSION_EXPIRY,
  _e as SESSION_REQUEST_EXPIRY_BOUNDARIES,
  De as SIGN_CLIENT_CONTEXT,
  me as SIGN_CLIENT_DEFAULT,
  Rs as SIGN_CLIENT_EVENTS,
  Ce as SIGN_CLIENT_PROTOCOL,
  vs as SIGN_CLIENT_STORAGE_OPTIONS,
  we as SIGN_CLIENT_STORAGE_PREFIX,
  ke as SIGN_CLIENT_VERSION,
  Qs as SessionStore,
  Hs as SignClient,
  yt as TVF_METHODS,
