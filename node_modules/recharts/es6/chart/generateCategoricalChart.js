...
export var generateCategoricalChart = function generateCategoricalChart(_ref6) {
  ...
  var getFormatItems = function getFormatItems(props, currentState) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var itemProps =
        item.type.defaultProps !== undefined
      ...
      if (itemIsBar) {
        ...
        var maxBarSize = isNil(childMaxBarSize)
          ? globalMaxBarSize
          : childMaxBarSize;
        var barBandSize =
          (_ref7 =
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _defineProperty(
        ...
        function (element, displayName, index) {
          ...
          var elementProps =
            elementDefaultProps !== undefined
              ? _objectSpread(
                  _objectSpread({}, elementDefaultProps),
                  element.props
                )
              : element.props;
          var axisOption =
          ...
          if (hasActive) {
            if (activeTooltipIndex >= 0) {
              ...
              if (activeShape || activeBar) {
                var activeIndex =
                  element.props.activeIndex !== undefined
              ...
              return [
                /*#__PURE__*/ cloneElement(xyItem, elementProps),
                null,
                null,
              ];
            }
          ...
          if (formattedGraphicalItems && formattedGraphicalItems.length) {
            for (
              ...
              if (itemDisplayName === "Bar") {
                ...
                var childIndex =
                  itemProps.activeIndex === undefined
                    ? activeIndex
  ...
  var CategoricalChart = /*#__PURE__*/ forwardRef(function CategoricalChart(
    props,
    ref
  ) {
    return /*#__PURE__*/ React.createElement(
