  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps =
          barItemDefaultProps !== undefined
            ? _objectSpread(
                _objectSpread({}, barItemDefaultProps),
                barItems[0].props
              )
            : barItems[0].props;
  ...
  if (legendProps) {
    ...
    if (
      ...
      return _objectSpread(
        ...
        {},
        _defineProperty({}, align, offset[align] + (boxWidth || 0))
      );
    }
    if (
      (layout === "horizontal" ||
...
export function getCateCoordinateOfLine(_ref5) {
  ...
  var value = getValueByDataKey(
    entry,
    !isNil(dataKey) ? dataKey : axis.dataKey
  );
...
export var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps
    ? _objectSpread(
        _objectSpread({}, graphicalItem.type.defaultProps),
        graphicalItem.props
      )
    : graphicalItem.props;
  var dataKey = defaultedProps.dataKey,
    ...
    hide = defaultedProps.hide;
  return _objectSpread(
    _objectSpread({}, filterProps(graphicalItem, false)),
    {},
    {
      dataKey: dataKey,
      unit: unit,
