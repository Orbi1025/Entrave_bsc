...
export function Shape(_ref2) {
  ...
  var shape;
  if (/*#__PURE__*/ isValidElement(option)) {
    shape = /*#__PURE__*/ cloneElement(
      option,
      _objectSpread(_objectSpread({}, props), getPropsFromShapeOption(option))
    );
...
export function getActiveShapeIndexForTooltip(_ref3) {
  ...
  var activeItemMatches = itemData.filter(function (datum, dataIndex) {
    ...
    var mouseCoordinateMatches = graphicalItem.props[shapeKey].filter(function (
      shapeData
    ) {
