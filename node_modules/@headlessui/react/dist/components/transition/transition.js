...
function Fe(e, t) {
  ...
  let {
    ...
    r = b(null),
    f = ue(e),
    U = oe(...(f ? [r, t, s] : t === null ? [] : [t])),
    H = (ee = i.unmount) == null || ee ? P.Unmount : P.Hidden,
    { show: u, appear: z, initial: K } = He(),
    [m, j] = O(u ? "visible" : "hidden"),
    Q = Ae(),
  ...
  D(() => A(r), [A, r]),
    D(() => {
      if (H === P.Hidden && r.current) {
        ...
        return le(m, { ["hidden"]: () => F(r), ["visible"]: () => A(r) });
      }
    }, [m, r, A, F, u, H]);
  let G = re();
  D(() => {
    if (f && G && m === "visible" && r.current === null)
      throw new Error(
  ...
  m === "visible" && (N |= x.Open),
    m === "hidden" && (N |= x.Closed),
    u && m === "hidden" && (N |= x.Opening),
    !u && m === "visible" && (N |= x.Closing);
  let he = ae();
...
function Ie(e, t) {
  ...
  let p = se();
  if (
    (n === void 0 && p !== null && (n = (p & x.Open) === x.Open), n === void 0)
  )
    throw new Error(
      "A <Transition /> is used but it is missing a `show={true | false}` prop."
    );
  let [h, g] = O(n ? "visible" : "hidden"),
    v = Te(() => {
      n || g("hidden");
    }),
    [o, i] = O(!0),
...
function Le(e, t) {
  ...
  return c.createElement(
    ...
    null,
    !n && l
      ? c.createElement(X, { ref: t, ...e })
      : c.createElement(me, { ref: t, ...e })
  );
}
let X = J(Ie),
  me = J(Fe),
...
export { Ke as Transition, Oe as TransitionChild };
