...
import { useEscape as ce } from "../../hooks/use-escape.js";
import { useEvent as A } from "../../hooks/use-event.js";
import { useId as k } from "../../hooks/use-id.js";
import { useInertOthers as me } from "../../hooks/use-inert-others.js";
import { useIsTouchDevice as De } from "../../hooks/use-is-touch-device.js";
import { useIsoMorphicEffect as Pe } from "../../hooks/use-iso-morphic-effect.js";
import { useOnDisappear as ye } from "../../hooks/use-on-disappear.js";
import { useOutsideClick as Ee } from "../../hooks/use-outside-click.js";
import { useOwnerDocument as Ae } from "../../hooks/use-owner.js";
import {
  MainTreeProvider as Y,
  useMainTreeNode as _e,
  useRootContainers as Ce,
...
import { useSlot as L } from "../../hooks/use-slot.js";
import { useSyncRefs as G } from "../../hooks/use-sync-refs.js";
import { CloseProvider as be } from "../../internal/close-provider.js";
import {
  ResetOpenClosedProvider as ve,
  State as x,
  useOpenClosed as J,
} from "../../internal/open-closed.js";
import { ForcePortalRoot as K } from "../../internal/portal-force-root.js";
import { stackMachines as Le } from "../../machines/stack-machine.js";
import { useSlice as xe } from "../../react-glue.js";
import { match as he } from "../../utils/match.js";
import {
  RenderFeatures as X,
...
import {
  Portal as Ie,
  PortalGroup as Me,
  useNestedPortals as ke,
} from "../portal/portal.js";
import {
  Transition as Ge,
  TransitionChild as q,
...
function He(e, t) {
  return he(t.type, Ue, e, t);
}
let z = _(function (t, o) {
    let a = k(),
      {
    ...
    let g = J();
    i === void 0 && g !== null && (i = (g & x.Open) === x.Open);
    let T = j(null),
      I = G(T, o),
      F = Ae(T.current),
      c = i ? 0 : 1,
      [b, Q] = ge(He, { titleId: null, descriptionId: null, panelRef: se() }),
      m = A(() => p(!1)),
      B = A((r) => Q({ type: 0, id: r })),
      D = Fe() ? c === 0 : !1,
      [Z, ee] = ke(),
      ...
      v = _e(),
      { resolveContainers: M } = Ce({
        mainTreeNode: v,
        portals: Z,
        defaultContainers: [te],
      }),
      U = g !== null ? (g & x.Closing) === x.Closing : !1;
    me(u || U ? !1 : D, {
      allowed: A(() => {
        var r, W;
        return [
    ...
    let H = xe(
      P,
      de((r) => P.selectors.isTop(r, n), [P, n])
    );
    Ee(H, M, (r) => {
      r.preventDefault(), m();
    }),
      ce(H, F == null ? void 0 : F.defaultView, (r) => {
        r.preventDefault(),
          r.stopPropagation(),
  ...
  return (a !== void 0 || o) && !n.static
    ? l.createElement(
        ...
        l.createElement(
          ...
          l.createElement(z, { ref: t, ...n })
        )
      )
    : l.createElement(Y, null, l.createElement(z, { ref: t, open: a, ...n }));
}
let je = "div";
function Ye(e, t) {
  let o = k(),
...
function Ke(e, t) {
  let { transition: o = !1, ...a } = e,
    [{ dialogState: n, unmount: i }] = O("Dialog.Backdrop"),
    p = L({ open: n === 0 }),
...
let qe = _($e),
  ...
  Qe = _(Ve),
  xt = V,
  ht = Object.assign(qe, { Panel: ze, Title: Qe, Description: V });
export {
  ht as Dialog,
