...
let c = d(() => new Map(), {
  PUSH(e, o) {
    ...
    let t =
      (n = this.get(e)) != null
        ? n
        : { doc: e, count: 0, d: s(), meta: new Set(), computedMeta: {} };
    return (
      t.count++,
      t.meta.add(o),
      (t.computedMeta = r(t.meta)),
      this.set(e, t),
      this
    );
  },
  POP(e, o) {
    let t = this.get(e);
    return (
      t && (t.count--, t.meta.delete(o), (t.computedMeta = r(t.meta))), this
    );
  },
  SCROLL_PREVENT(e) {
    let o = {
      ...
      t = [l(), i(), p()];
    t.forEach(({ before: n }) => (n == null ? void 0 : n(o))),
      t.forEach(({ after: n }) => (n == null ? void 0 : n(o)));
  },
  SCROLL_ALLOW({ d: e }) {
    e.dispose();
  },
...
c.subscribe(() => {
  ...
  for (let t of e.values()) {
    let n = o.get(t.doc) === "hidden",
      a = t.count !== 0;
    ((a && !n) || (!a && n)) &&
      c.dispatch(t.count > 0 ? "SCROLL_PREVENT" : "SCROLL_ALLOW", t),
      t.count === 0 && c.dispatch("TEARDOWN", t);
  }
});
export { c as overflows };
