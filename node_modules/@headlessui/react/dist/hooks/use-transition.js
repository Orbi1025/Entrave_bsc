var T, S;
import { useRef as c, useState as b } from "react";
...
typeof process != "undefined" &&
  ...
  ((T = process == null ? void 0 : process.env) == null
    ? void 0
    : T["NODE_ENV"]) === "test" &&
  typeof ((S = Element == null ? void 0 : Element.prototype) == null
    ? void 0
    : S.getAnimations) == "undefined" &&
...
function N(e, r, t, n) {
  let [i, a] = b(t),
    { hasFlag: s, addFlag: o, removeFlag: l } = y(e && i ? 3 : 0),
    u = c(!1),
    f = c(!1),
    E = g();
  return (
    L(() => {
      ...
      if (e) {
        ...
        return (
          (d = n == null ? void 0 : n.start) == null || d.call(n, t),
          C(r, {
            inFlight: u,
            prepare() {
              f.current ? (f.current = !1) : (f.current = u.current),
                (u.current = !0),
                !f.current && (t ? (o(3), l(4)) : (o(4), l(2)));
            },
            run() {
              ...
              (f.current && D(r)) ||
                ...
                l(7),
                t || a(!1),
                (p = n == null ? void 0 : n.end) == null || p.call(n, t));
            },
          })
        );
      }
...
function M(e, r) {
  ...
  let i =
    (s =
      (a = e.getAnimations) == null
        ? void 0
        : a.call(e).filter((o) => o instanceof CSSTransition)) != null
      ? s
      : [];
  return i.length === 0
    ? (r(), t.dispose)
    : (Promise.allSettled(i.map((o) => o.finished)).then(() => {
        n || r();
      }),
      t.dispose);
}
...
function D(e) {
  var t, n;
  return (
    (n = (t = e.getAnimations) == null ? void 0 : t.call(e)) != null ? n : []
  ).some((i) => i instanceof CSSTransition && i.playState !== "finished");
}
export { x as transitionDataAttributes, N as useTransition };
