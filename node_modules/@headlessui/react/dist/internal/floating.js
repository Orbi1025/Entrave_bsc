import {
  ...
  size as le,
  useFloating as oe,
  useInnerOffset as ie,
  useInteractions as se,
...
function ye(e) {
  return R(() => (e ? (typeof e == "string" ? { to: e } : e) : null), [e]);
}
function Fe() {
...
function Te() {
  let { getFloatingProps: e, slot: t } = T(y);
  return ae(
...
function Ae({ children: e, enabled: t = !0 }) {
  ...
  let {
      ...
      transform: !1,
      middleware: [
        ne({ mainAxis: a === "selection" ? 0 : E, crossAxis: A }),
        re({ padding: c }),
        a !== "selection" && ee({ padding: c }),
        a === "selection" && h
          ? te({
              ...h,
              padding: c,
              ...
              onFallbackChange(P) {
                ...
                if (!d) return;
                let M =
                    parseFloat(getComputedStyle(d).scrollPaddingBottom) || 0,
                  I = Math.min(D, d.childElementCount),
                  W = 0,
                  B = 0;
                for (let m of (N =
                  (L = g.elements.floating) == null ? void 0 : L.childNodes) !=
                null
                  ? N
                  : [])
                  if (pe.isHTMLElement(m)) {
                    let x = m.offsetTop,
                    ...
                    if (x >= H && k <= U) I--;
                      ...
                      (B = Math.max(0, Math.min(k, U) - Math.max(x, H))),
                        (W = m.clientHeight);
                      break;
                    }
                  }
  ...
  let G = R(() => ({ anchor: [w, V].filter(Boolean).join(" ") }), [w, V]),
    K = ie(g, { overflowRef: u, onChange: o }),
    { getReferenceProps: Q, getFloatingProps: X } = se([K]),
    Y = z((P) => {
      s(P), b.setFloating(P);
    });
...
function ge(e, t) {
  var o, u, f;
  let n = O(
      (o = e == null ? void 0 : e.gap) != null ? o : "var(--anchor-gap, 0)",
      t
    ),
    r = O(
      (u = e == null ? void 0 : e.offset) != null
        ? u
        : "var(--anchor-offset, 0)",
      t
    ),
    l = O(
      (f = e == null ? void 0 : e.padding) != null
        ? f
        : "var(--anchor-padding, 0)",
      t
    );
  return { ...e, gap: n, offset: r, padding: l };
}
      ...
      if (typeof s == "string") {
        ...
        return [
          ...
          (E) => {
            ...
            {
              let c = A.map((h) =>
                window.getComputedStyle(i).getPropertyValue(h)
              );
...
export {
  Ae as FloatingProvider,
  Re as useFloatingPanel,
  Te as useFloatingPanelProps,
  Fe as useFloatingReference,
  be as useFloatingReferenceProps,
  ye as useResolvedAnchor,
};
