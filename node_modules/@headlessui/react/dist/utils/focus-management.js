...
import * as y from "./dom.js";
import { match as L } from "./match.js";
import {
  getActiveElement as b,
  getOwnerDocument as F,
  getRootNode as f,
} from "./owner.js";
let E = [
    ...
    .join(","),
  S = ["[data-autofocus]"].map((e) => `${e}:not([tabindex='-1'])`).join(",");
var T = ((o) => (
    (o[(o.First = 1)] = "First"),
...
function x(e = document.body) {
  return e == null
    ? []
    : Array.from(e.querySelectorAll(E)).sort((r, t) =>
        Math.sign(
...
function h(e = document.body) {
  return e == null
    ? []
    : Array.from(e.querySelectorAll(S)).sort((r, t) =>
        Math.sign(
          (r.tabIndex || Number.MAX_SAFE_INTEGER) -
            (t.tabIndex || Number.MAX_SAFE_INTEGER)
        )
...
function H(e, r = 0) {
  var t;
  return e === ((t = F(e)) == null ? void 0 : t.body)
    ? !1
    : L(r, {
        [0]() {
          return e.matches(E);
...
function K(e) {
  p().nextFrame(() => {
    let r = b(e);
    r && y.isHTMLorSVGElement(r) && !H(r, 0) && w(e);
  });
}
var g = ((t) => (
...
function P(e) {
  var r, t;
  return (t =
    (r = e == null ? void 0 : e.matches) == null ? void 0 : r.call(e, _)) !=
    null
    ? t
    : !1;
}
...
function R(e, r, t = e === null ? document.body : f(e)) {
  return v(x(t), r, { relativeTo: e });
}
function v(
  e,
  r,
  { sorted: t = !0, relativeTo: l = null, skipElements: n = [] } = {}
) {
  let a = Array.isArray(e) ? (e.length > 0 ? f(e[0]) : document) : f(e),
    u = Array.isArray(e) ? (t ? G(e) : e) : r & 64 ? h(e) : x(e);
  n.length > 0 &&
    u.length > 1 &&
    (u = u.filter(
      (i) =>
        !n.some((d) =>
          d != null && "current" in d
            ? (d == null ? void 0 : d.current) === i
            : d === i
        )
    )),
    (l = l != null ? l : a == null ? void 0 : a.activeElement);
  let o = (() => {
      if (r & 5) return 1;
      if (r & 10) return -1;
      throw new Error(
...
export {
  ...
  R as focusFrom,
  v as focusIn,
  E as focusableSelector,
  h as getAutoFocusableElements,
  x as getFocusableElements,
  H as isFocusableElement,
  K as restoreFocusIfNecessary,
  G as sortByDomNode,
};
