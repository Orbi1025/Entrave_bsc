...
import { match as O } from "./match.js";
var A = ((a) => (
    (a[(a.None = 0)] = "None"),
...
function F(n, r = {}, e, a, s) {
  ...
  if (b(t) && (Object.keys(m(o)).length > 0 || Object.keys(m(u)).length > 0))
    if (!k(f) || (Array.isArray(f) && f.length > 1) || D(f)) {
...
`)
      ...
      return v(f, Object.assign({}, g, u, y, { ref: s(H(f), y.ref) }, T));
    }
  return S(t, Object.assign({}, h(o, ["ref"]), !b(t) && y, !b(t) && u), f);
}
function $() {
  let n = M([]),
    r = x((e) => {
...
function b(n) {
  return n === j || n === Symbol.for("react.fragment");
}
function D(n) {
  return b(n.type);
}
export {
  ...
  C as RenderStrategy,
  m as compact,
  Y as forwardRefWithAs,
  b as isFragment,
  D as isFragmentInstance,
  V as mergeProps,
  K as useRender,
};
