...
var i = (t, e, r) => (
    b(t, e, "read from private field"), r ? r.call(t) : e.get(t)
  ),
  c = (t, e, r) => {
    if (e.has(t))
  ...
  u = (t, e, r, s) => (
    b(t, e, "write to private field"), s ? s.call(t, r) : e.set(t, r), r
  );
var n, a, o;
import { DefaultMap as m } from "./utils/default-map.js";
import { disposables as y } from "./utils/disposables.js";
import { env as d } from "./utils/env.js";
class T {
  constructor(e) {
    c(this, n, {});
    c(this, a, new m(() => new Set()));
    c(this, o, new Set());
    S(this, "disposables", y());
    u(this, n, e),
      d.isServer &&
  ...
  subscribe(e, r) {
    if (d.isServer) return () => {};
    let s = { selector: e, callback: r, current: e(i(this, n)) };
    return (
      i(this, o).add(s),
...
function j(t, e) {
  return Object.is(t, e)
    ? !0
    : typeof t != "object" || t === null || typeof e != "object" || e === null
    ? !1
    : Array.isArray(t) && Array.isArray(e)
    ? t.length !== e.length
      ? !1
      : f(t[Symbol.iterator](), e[Symbol.iterator]())
    : (t instanceof Map && e instanceof Map) ||
      (t instanceof Set && e instanceof Set)
    ? t.size !== e.size
      ? !1
      : f(t.entries(), e.entries())
    : p(t) && p(e)
    ? f(
...
export { T as Machine, k as batch, j as shallowEqual };
