...
function T(n, l, u) {
  "-" === l[0]
    ...
    : (n[l] =
        null == u ? "" : "number" != typeof u || p.test(l) ? u : u + "px");
}
    ...
    try {
      ...
      (h.state = h.__s),
        ...
        x &&
          ...
          (_ = h.getSnapshotBeforeUpdate(p, w)),
        S(
          n,
          y(
            (L =
              null != a && a.type === b && null == a.key ? a.props.children : a)
          )
            ? L
            : [L],
          u,
...
function z(u, t, i, o, r, f, e, c, s) {
  ...
  if (null == u) {
    ...
    (u = document.createElementNS(r, C, k.is && k)),
      c && (l.__m && l.__m(t, f), (c = !1)),
      (f = null);
  }
  if (null === C) b === k || (c && u.data === k) || (u.data = k);
  else {
    if (((f = f && n.call(u.childNodes)), (b = i.props || h), !c && null != f))
      for (b = {}, a = 0; a < u.attributes.length; a++)
        b[(_ = u.attributes[a]).name] = _.value;
    for (a in b)
      if (((_ = b[a]), "children" == a));
    ...
    for (a in k)
      (_ = k[a]),
        "children" == a
          ...
          : "checked" == a
          ? (m = _)
          : (c && "function" != typeof _) || b[a] === _ || A(u, a, _, b[a], r);
    if (v)
      c ||
        (p && (v.__html === p.__html || v.__html === u.innerHTML)) ||
        (u.innerHTML = v.__html),
        (t.__k = []);
    else if (
      (p && (u.innerHTML = ""),
      S(
