...
export class WalletLinkSigner {
  ...
  updateProviderInfo(jsonRpcUrl, chainId) {
    ...
    if (chainChanged) {
      (_a = this.callback) === null || _a === void 0
        ? void 0
        : _a.call(this, "chainChanged", hexStringFromNumber(chainId));
    }
  }
  ...
  _setAddresses(addresses, _) {
    ...
    (_a = this.callback) === null || _a === void 0
      ? void 0
      : _a.call(this, "accountsChanged", newAddresses);
  ...
  _prepareTransactionParams(tx) {
    ...
    const gasPriceInWei =
      tx.gasPrice != null ? ensureBigInt(tx.gasPrice) : null;
    const maxFeePerGas =
      tx.maxFeePerGas != null ? ensureBigInt(tx.maxFeePerGas) : null;
    const maxPriorityFeePerGas =
      tx.maxPriorityFeePerGas != null
        ? ensureBigInt(tx.maxPriorityFeePerGas)
        : null;
    const gasLimit = tx.gas != null ? ensureBigInt(tx.gas) : null;
    const chainId = tx.chainId
      ? ensureIntNumber(tx.chainId)
      : this.getChainId();
    return {
      fromAddress,
      toAddress,
  ...
  getChainId() {
    ...
    return Number.parseInt(
      (_a = this._storage.getItem(DEFAULT_CHAIN_ID_KEY)) !== null &&
        _a !== void 0
        ? _a
        : "1",
      10
  ...
  async _eth_requestAccounts() {
    ...
    (_b = this.callback) === null || _b === void 0
      ? void 0
      : _b.call(this, "connect", {
          chainId: hexStringFromNumber(this.getChainId()),
        });
    return this._addresses;
  }
