...
export function getCoinbaseInjectedProvider({ metadata, preference }) {
  ...
  if (preference.options !== "smartWalletOnly") {
    ...
    if (extension) {
      (_a = extension.setAppInfo) === null || _a === void 0
        ? void 0
        : _a.call(extension, appName, appLogoUrl, appChainIds, preference);
      return extension;
    }
  }
  ...
  if (
    ...
    (_b = ethereum.setAppInfo) === null || _b === void 0
      ? void 0
      : _b.call(ethereum, appName, appLogoUrl, appChainIds, preference);
    return ethereum;
  }
  return undefined;
}
