...
export function createBaseAccountSDK(params) {
  ...
  //  ====================================================================
  if (
    (_b = params.subAccounts) === null || _b === void 0
      ? void 0
      : _b.toOwnerAccount
  ) {
  ...
  store.subAccountsConfig.set({
    toOwnerAccount:
      (_c = params.subAccounts) === null || _c === void 0
        ? void 0
        : _c.toOwnerAccount,
    // @ts-expect-error - enableSubAccounts is not officially supported yet
    enableAutoSubAccounts:
      (_d = params.subAccounts) === null || _d === void 0
        ? void 0
        : _d.enableAutoSubAccounts,
  });
  //  ====================================================================
  ...
  const sdk = {
    getProvider: () => {
      ...
      if (!provider) {
        provider =
          (_a = getInjectedProvider()) !== null && _a !== void 0
            ? _a
    ...
    subAccount: {
      async create(accountParam) {
        var _a;
        return await ((_a = sdk.getProvider()) === null || _a === void 0
          ? void 0
          : _a.request({
      ...
      async get() {
        ...
        const response = await ((_a = sdk.getProvider()) === null ||
        _a === void 0
          ? void 0
          : _a.request({
        ...
        const subAccounts =
          (_b = response.accounts[0].capabilities) === null || _b === void 0
            ? void 0
            : _b.subAccounts;
              ...
              params: [
                {
                  ...
                  from:
                    (_b = account.accounts) === null || _b === void 0
                      ? void 0
                      : _b[0],
                  version: "1",
                },
