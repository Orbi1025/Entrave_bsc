      ...
      render(
        _jsx("div", {
          children: _jsx(DialogContainer, {
            children: Array.from(this.items.entries()).map(([key, itemProps]) =>
              _createElement(
                DialogInstance,
                Object.assign({}, itemProps, {
                  ...
                  handleClose: () => {
                    var _a;
                    this.clear();
                    (_a = itemProps.onClose) === null || _a === void 0
                      ? void 0
                      : _a.call(itemProps);
                  },
                })
...
export const DialogInstance = ({
  ...
  useEffect(() => {
    const fetchEnsName = async () => {
      var _a;
      const address =
        (_a = store.account.get().accounts) === null || _a === void 0
          ? void 0
          : _a[0];
      if (address) {
    ...
    children: [
      ...
      actionItems &&
        ...
        _jsx("div", {
          ...
          children: actionItems.map((action, i) =>
            _jsx(
              "button",
              {
                class: clsx(
