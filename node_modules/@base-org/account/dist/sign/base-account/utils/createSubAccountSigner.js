...
export async function createSubAccountSigner({
  ...
  const chainId =
    (_a = client.chain) === null || _a === void 0 ? void 0 : _a.id;
  if (!chainId) {
    ...
    try {
      switch (args.method) {
        ...
        case "eth_sendTransaction": {
          ...
          assertPresence(
            rawParams.to,
            standardErrors.rpc.invalidParams("to is required")
          );
          const params = {
            to: rawParams.to,
            data: ensureHexString(
              (_a = rawParams.data) !== null && _a !== void 0 ? _a : "0x",
              true
            ),
            value: ensureHexString(
              (_b = rawParams.value) !== null && _b !== void 0 ? _b : "0x",
              true
            ),
            from:
              (_c = rawParams.from) !== null && _c !== void 0
                ? _c
                : subAccount.address,
          };
        ...
        case "wallet_sendCalls": {
          ...
          if (parentAddress) {
            prepareCallsRequest = injectRequestCapabilities(
              prepareCallsRequest,
              {
                funding: [
                  {
          ...
          const signResponse = await ((_e = (_d = owner).sign) === null ||
          _e === void 0
            ? void 0
            : _e.call(_d, {
                ...
                signature: JSON.stringify(
                  convertCredentialToJSON(
                    Object.assign(
                      {
                        id:
                          (_f = owner.id) !== null && _f !== void 0 ? _f : "1",
                      },
                      signResponse
                    )
                  )
