...
export class Signer {
  constructor(params) {
    ...
    this.chain =
      (_b = account.chain) !== null && _b !== void 0
        ? _b
        : {
            id:
              (_d =
                (_c = params.metadata.appChainIds) === null || _c === void 0
                  ? void 0
                  : _c[0]) !== null && _d !== void 0
                ? _d
                : 1,
  ...
  async handshake(args) {
    ...
    try {
      ...
      await ((_b = (_a = this.communicator).waitForPopupLoaded) === null ||
      _b === void 0
        ? void 0
        : _b.call(_a));
  ...
  async _request(request) {
        ...
        case "wallet_connect": {
          ...
          if (requestHasCapability(request, "addSubAccount")) {
            capabilitiesToInject =
              (_d =
                (_c = store.subAccountsConfig.get()) === null || _c === void 0
                  ? void 0
                  : _c.capabilities) !== null && _d !== void 0
                ? _d
                : {};
          }
    ...
    switch (request.method) {
      ...
      case "eth_accounts": {
        ...
        if (
          subAccount === null || subAccount === void 0
            ? void 0
            : subAccount.address
        ) {
          ...
          this.accounts = (
            subAccountsConfig === null || subAccountsConfig === void 0
              ? void 0
        ...
        (_e = this.callback) === null || _e === void 0
          ? void 0
          : _e.call(this, "connect", { chainId: numberToHex(this.chain.id) });
      ...
      case "wallet_connect": {
        ...
        // Wait for the popup to be loaded before making async calls
        await ((_g = (_f = this.communicator).waitForPopupLoaded) === null ||
        _g === void 0
          ? void 0
          : _g.call(_f));
        await initSubAccountConfig();
        ...
        const modifiedRequest = injectRequestCapabilities(
          ...
          (_h =
            subAccountsConfig === null || subAccountsConfig === void 0
              ? void 0
              : subAccountsConfig.capabilities) !== null && _h !== void 0
            ? _h
            : {}
        );
        const result = await this.sendRequestToPopup(modifiedRequest);
        (_j = this.callback) === null || _j === void 0
          ? void 0
          : _j.call(this, "connect", { chainId: numberToHex(this.chain.id) });
        return result;
      }
      // Sub Account Support
      ...
      case "coinbase_fetchPermissions": {
        ...
        const requestedChainId = hexToNumber(
          (_k = completeRequest.params) === null || _k === void 0
            ? void 0
            : _k[0].chainId
        );
        store.spendPermissions.set(
          permissions.permissions.map((permission) =>
            Object.assign(Object.assign({}, permission), {
  ...
  async handleResponse(request, decrypted) {
    ...
    switch (request.method) {
      case "eth_requestAccounts": {
        ...
        (_a = this.callback) === null || _a === void 0
          ? void 0
          : _a.call(this, "accountsChanged", accounts);
        break;
      }
      case "wallet_connect": {
          ...
          (_c =
            (_b =
              response === null || response === void 0
                ? void 0
                : response.accounts) === null || _b === void 0
              ? void 0
              : _b[0].capabilities) === null || _c === void 0
            ? void 0
            : _c.spendPermissions;
        if (spendPermissions && "permissions" in spendPermissions) {
          store.spendPermissions.set(
            spendPermissions === null || spendPermissions === void 0
              ? void 0
              : spendPermissions.permissions
          );
        }
        (_d = this.callback) === null || _d === void 0
          ? void 0
          : _d.call(this, "accountsChanged", accounts_);
        break;
      }
      case "wallet_addSubAccount": {
        ...
        (_e = this.callback) === null || _e === void 0
          ? void 0
          : _e.call(this, "accountsChanged", this.accounts);
        break;
      }
      default:
        break;
        ...
        (_b =
          (_a =
            metadata === null || metadata === void 0
              ? void 0
              : metadata.appChainIds) === null || _a === void 0
            ? void 0
            : _a[0]) !== null && _b !== void 0
          ? _b
          : 1,
  ...
  async handleGetCapabilitiesRequest(request) {
    ...
    if (
      !this.accounts.some((account) =>
        isAddressEqual(account, requestedAccount)
      )
    ) {
      throw standardErrors.provider.unauthorized(
    ...
    const filterChainNumbers = new Set(
      filterChainIds.map((chainId) => hexToNumber(chainId))
    );
    // Filter capabilities
  ...
  async decryptResponseMessage(message) {
    ...
    if (availableChains) {
      ...
      const chains = Object.entries(availableChains).map(([id, rpcUrl]) => {
        const nativeCurrency =
          nativeCurrencies === null || nativeCurrencies === void 0
            ? void 0
            : nativeCurrencies[Number(id)];
    ...
    const walletCapabilities =
      (_c = response.data) === null || _c === void 0 ? void 0 : _c.capabilities;
  ...
  updateChain(chainId, newAvailableChains) {
    ...
    const chains =
      newAvailableChains !== null && newAvailableChains !== void 0
        ? newAvailableChains
        : state.chains;
    const chain =
      chains === null || chains === void 0
        ? void 0
    ...
    if (chain !== this.chain) {
      ...
      (_a = this.callback) === null || _a === void 0
        ? void 0
        : _a.call(this, "chainChanged", hexStringFromNumber(chain.id));
    }
    return true;
  }
  async addSubAccount(request) {
    ...
    const subAccountsConfig = store.subAccountsConfig.get();
    if (
      subAccount === null || subAccount === void 0 ? void 0 : subAccount.address
    ) {
      this.accounts = (
        subAccountsConfig === null || subAccountsConfig === void 0
          ? void 0
      ...
      (_a = this.callback) === null || _a === void 0
        ? void 0
        : _a.call(this, "accountsChanged", this.accounts);
      return subAccount;
    }
    // Wait for the popup to be loaded before sending the request
    await ((_c = (_b = this.communicator).waitForPopupLoaded) === null ||
    _c === void 0
      ? void 0
      : _c.call(_b));
    if (
      ...
      let keys;
      if (
        request.params[0].account.keys &&
        request.params[0].account.keys.length > 0
      ) {
        keys = request.params[0].account.keys;
      } else {
        const config =
          (_d = store.subAccountsConfig.get()) !== null && _d !== void 0
            ? _d
            : {};
  ...
  async sendRequestToSubAccountSigner(request) {
    ...
    const ownerAccount = (
      subAccountsConfig === null || subAccountsConfig === void 0
        ? void 0
        : subAccountsConfig.toOwnerAccount
    )
      ? await subAccountsConfig.toOwnerAccount()
      : await getCryptoKeyAccount();
    assertPresence(
      ownerAccount === null || ownerAccount === void 0
        ? void 0
    ...
    const dataSuffix = makeDataSuffix({
      attribution:
        (_a = config.preference) === null || _a === void 0
          ? void 0
          : _a.attribution,
