...
export function getSenderFromRequest(request) {
  ...
  switch (request.method) {
    ...
    case "wallet_sendCalls":
      return (_a = request.params[0]) === null || _a === void 0
        ? void 0
        : _a.from;
    default:
      return null;
...
export function injectRequestCapabilities(request, capabilities) {
  ...
  if (capabilities && request.method.startsWith("wallet_")) {
    ...
    requestCapabilities = Object.assign(
      Object.assign({}, capabilities),
      requestCapabilities
    );
    if (modifiedRequest.params && Array.isArray(modifiedRequest.params)) {
      modifiedRequest.params[0] = Object.assign(
        Object.assign({}, modifiedRequest.params[0]),
...
export async function initSubAccountConfig() {
  var _a;
  const config =
    (_a = store.subAccountsConfig.get()) !== null && _a !== void 0 ? _a : {};
  const capabilities = {};
...
export function fillMissingParamsForFetchPermissions(request) {
  ...
  const accountFromStore =
    (_a = store.getState().account.accounts) === null || _a === void 0
      ? void 0
      : _a[0];
  const chainId =
    (_b = store.getState().account.chain) === null || _b === void 0
      ? void 0
      : _b.id;
  const subAccountFromStore =
    (_c = store.getState().subAccount) === null || _c === void 0
      ? void 0
      : _c.address;
...
export async function waitForCallsTransactionHash({ client, id }) {
  ...
  if (result.status === "success") {
    return (_a = result.receipts) === null || _a === void 0
      ? void 0
      : _a[0].transactionHash;
  }
...
export function createWalletSendCallsRequest({
  ...
  if (
    paymasterUrls === null || paymasterUrls === void 0
      ? void 0
  ...
  for (const [token, { amount, sources }] of Object.entries(
    (_a =
      errorData === null || errorData === void 0
        ? void 0
        : errorData.required) !== null && _a !== void 0
      ? _a
      : {}
  )) {
    const sourcesWithSufficientBalance = sources.filter((source) => {
      return (
        ...
        source.address.toLowerCase() ===
          (sourceAddress === null || sourceAddress === void 0
            ? void 0
...
export function requestHasCapability(request, capabilityName) {
  ...
  if (
    ...
    return false;
  const capabilities =
    (_a = request.params[0]) === null || _a === void 0
      ? void 0
      : _a.capabilities;
